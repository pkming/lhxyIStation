...
public final class TimeUtils {
    ...
    private static int formatDurationLocked(long j, int i) {
        ...
        int i10 = i6 + 1;
        boolean z = i != 0;
        int iPrintField = printField(cArr, i2, DateFormat.DATE, i10, false, 0);
        int iPrintField2 = printField(cArr, i3, DateFormat.HOUR, iPrintField, iPrintField != i10, z ? 2 : 0);
        int iPrintField3 = printField(cArr, i5, DateFormat.MINUTE, iPrintField2, iPrintField2 != i10, z ? 2 : 0);
        int iPrintField4 = printField(cArr, i4, 's', iPrintField3, iPrintField3 != i10, z ? 2 : 0);
        int iPrintField5 = printField(cArr, i8, DateFormat.MINUTE, iPrintField4, true, (!z || iPrintField4 == i10) ? 0 : 3);
        cArr[iPrintField5] = 's';
