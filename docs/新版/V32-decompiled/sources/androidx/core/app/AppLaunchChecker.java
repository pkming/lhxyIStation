...
public class AppLaunchChecker {
    ...
    public static void onActivityCreate(Activity activity) {
        ...
        if (sharedPreferences.getBoolean(KEY_STARTED_FROM_LAUNCHER, false) || (intent = activity.getIntent()) == null || !Intent.ACTION_MAIN.equals(intent.getAction())) {
            return;
        }
        if (intent.hasCategory(Intent.CATEGORY_LAUNCHER) || intent.hasCategory(IntentCompat.CATEGORY_LEANBACK_LAUNCHER)) {
