...
public abstract class PositionalDataSource<T> extends DataSource<Integer, T> {
    ...
    final void dispatchLoadInitial(boolean z, int i, int i2, int i3, Executor executor, PageResult.Receiver<T> receiver) {
    ...
    final void dispatchLoadRange(int i, int i2, int i3, Executor executor, PageResult.Receiver<T> receiver) {
    ...
    static class ContiguousWithoutPlaceholdersWrapper<Value> extends ContiguousDataSource<Integer, Value> {
        ...
        public void dispatchLoadInitial(Integer num, int i, int i2, boolean z, Executor executor, PageResult.Receiver<Value> receiver) {
            ...
            if (num == null) {
                ...
                numValueOf = Integer.valueOf(Math.max(0, ((num.intValue() - (i / 2)) / i2) * i2));
            }
            this.mSource.dispatchLoadInitial(false, numValueOf.intValue(), i, i2, executor, receiver);
        }

        @Override // androidx.paging.ContiguousDataSource
        void dispatchLoadAfter(int i, Value value, int i2, Executor executor, PageResult.Receiver<Value> receiver) {
            this.mSource.dispatchLoadRange(1, i + 1, i2, executor, receiver);
        }

        @Override // androidx.paging.ContiguousDataSource
        void dispatchLoadBefore(int i, Value value, int i2, Executor executor, PageResult.Receiver<Value> receiver) {
            int i3 = i - 1;
            if (i3 < 0) {
            ...
            this.mSource.dispatchLoadRange(2, (i3 - iMin) + 1, iMin, executor, receiver);
        }
