...
abstract class BaseMotionStrategy implements MotionStrategy {
    ...
    AnimatorSet createAnimator(MotionSpec motionSpec) {
        ...
        if (motionSpec.hasPropertyValues(BatteryManager.EXTRA_SCALE)) {
            arrayList.add(motionSpec.getAnimator(BatteryManager.EXTRA_SCALE, this.fab, View.SCALE_Y));
            arrayList.add(motionSpec.getAnimator(BatteryManager.EXTRA_SCALE, this.fab, View.SCALE_X));
        }
