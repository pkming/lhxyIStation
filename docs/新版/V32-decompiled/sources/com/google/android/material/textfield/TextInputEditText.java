...
public class TextInputEditText extends AppCompatEditText {
    ...
    private String getAccessibilityNodeInfoText(TextInputLayout textInputLayout) {
        ...
        StringBuilder sbAppend = new StringBuilder().append(string + (((z4 || z3) && !TextUtils.isEmpty(string)) ? ", " : ""));
        if (z4) {
            helperText = error;
        } else if (!z3) {
            helperText = "";
        }
        String string2 = sbAppend.append((Object) helperText).toString();
        if (z) {
            return ((Object) text) + (TextUtils.isEmpty(string2) ? "" : ", " + string2);
        }
