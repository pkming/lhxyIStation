...
public class WheelPicker extends View implements IDebug, IWheelPicker, Runnable {
    ...
    public WheelPicker(Context context, AttributeSet attributeSet) {
        ...
        int resourceId = typedArrayObtainStyledAttributes.getResourceId(R.styleable.WheelPicker_wheel_data, 0);
        this.mData = Arrays.asList(getResources().getStringArray(resourceId == 0 ? R.array.WheelArrayDefault : resourceId));
        this.mItemTextSize = typedArrayObtainStyledAttributes.getDimensionPixelSize(R.styleable.WheelPicker_wheel_item_text_size, getResources().getDimensionPixelSize(R.dimen.WheelItemTextSize));
        ...
        this.mItemTextColor = typedArrayObtainStyledAttributes.getColor(R.styleable.WheelPicker_wheel_item_text_color, Color.GRAY);
    ...
    protected void onSizeChanged(int i, int i2, int i3, int i4) {
        ...
        this.mHalfItemHeight = iHeight / 2;
        computeFlingLimitY();
    ...
    protected void onDraw(Canvas canvas) {
        ...
        while (i4 < this.mSelectedItemPosition + i3 + this.mDrawnItemCount) {
            if (this.isCyclic) {
                ...
                strValueOf = String.valueOf(this.mData.get(size));
            } else {
                strValueOf = isPosInRang(i4) ? String.valueOf(this.mData.get(i4)) : "";
            }
            ...
            if (this.isCurved) {
                float fAbs = (((i6 - Math.abs(i6 - i8)) - this.mRectDrawn.top) * 1.0f) / (this.mDrawnCenterY - this.mRectDrawn.top);
                int i9 = this.mDrawnCenterY;
                float f = (-(1.0f - fAbs)) * 90.0f * (i8 > i9 ? 1 : i8 < i9 ? -1 : 0);
                if (f < -90.0f) {
                    f = -90.0f;
                }
                float f2 = f <= 90.0f ? f : 90.0f;
                iComputeSpace = computeSpace((int) f2);
                int i10 = this.mWheelCenterX;
                int i11 = this.mItemAlign;
                if (i11 == 1) {
                    i10 = this.mRectDrawn.left;
                } else if (i11 == 2) {
                    i10 = this.mRectDrawn.right;
                }
                int i12 = this.mWheelCenterY - iComputeSpace;
                this.mCamera.save();
            ...
            if (this.hasAtmospheric) {
                int i13 = this.mDrawnCenterY;
                int iAbs = (int) ((((i13 - Math.abs(i13 - i8)) * 1.0f) / this.mDrawnCenterY) * 255.0f);
                this.mPaint.setAlpha(iAbs < 0 ? 0 : iAbs);
            }
            if (this.isCurved) {
            ...
            if (this.isDebug) {
                ...
                int i14 = this.mWheelCenterY + (this.mItemHeight * i5);
                float f8 = i14;
                canvas.drawLine(this.mRectDrawn.left, f8, this.mRectDrawn.right, f8, this.mPaint);
                this.mPaint.setColor(-13421586);
                this.mPaint.setStyle(Paint.Style.STROKE);
                canvas.drawRect(this.mRectDrawn.left, i14 - this.mHalfItemHeight, this.mRectDrawn.right, r11 + this.mItemHeight, this.mPaint);
                canvas.restore();
            }
            i4++;
            i5++;
