    ...
    public ValueAnimator mo76clone() {
        ...
        if (propertyValuesHolderArr != null) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                PropertyValuesHolder propertyValuesHolderMo80clone = propertyValuesHolderArr[i2].mo80clone();
                valueAnimator.mValues[i2] = propertyValuesHolderMo80clone;
                valueAnimator.mValuesMap.put(propertyValuesHolderMo80clone.getPropertyName(), propertyValuesHolderMo80clone);
            }
        }
        return valueAnimator;
    }
