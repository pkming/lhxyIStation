...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo76clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo76clone();
        ...
        for (Node node : this.mNodes) {
            Node nodeM77clone = node.m77clone();
            map.put(node, nodeM77clone);
            animatorSet.mNodes.add(nodeM77clone);
            animatorSet.mNodeMap.put(nodeM77clone.animation, nodeM77clone);
            ArrayList arrayList = null;
            nodeM77clone.dependencies = null;
            nodeM77clone.tmpDependencies = null;
            nodeM77clone.nodeDependents = null;
            nodeM77clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM77clone.animation.getListeners();
            if (listeners != null) {
    ...
    private static class Node implements Cloneable {
        ...
        public Node m77clone() {
            try {
                Node node = (Node) super.clone();
                node.animation = this.animation.mo76clone();
                return node;
