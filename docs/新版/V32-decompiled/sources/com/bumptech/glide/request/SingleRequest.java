...
public final class SingleRequest<R> implements Request, SizeReadyCallback, ResourceCallback, FactoryPools.Poolable {
    ...
    private void onResourceReady(Resource<R> resource, R r, DataSource dataSource) {
        ...
        try {
            ...
            if ((requestListener2 == null || !requestListener2.onResourceReady(r, this.model, this.target, dataSource, zIsFirstReadyResource)) && ((requestListener = this.targetListener) == null || !requestListener.onResourceReady(r, this.model, this.target, dataSource, zIsFirstReadyResource))) {
