...
public class NotificationTarget extends SimpleTarget<Bitmap> {
    ...
    private void update() {
        ((NotificationManager) Preconditions.checkNotNull((NotificationManager) this.context.getSystemService(Context.NOTIFICATION_SERVICE))).notify(this.notificationTag, this.notificationId, this.notification);
    }
