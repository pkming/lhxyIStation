...
public final class ag {
    ...
    public static class b {
        ...
        public final String toString() {
            return "SLAData{uuid='" + this.a + DateFormat.QUOTE + ", time=" + this.b + ", data='" + this.c + DateFormat.QUOTE + '}';
        }
    }
    ...
    private b b(c cVar) {
        ...
        String str = "&app_version=" + aaVarB.o + "&app_name=" + aaVarB.q + "&app_bundle_id=" + aaVarB.c + "&client_type=android&user_id=" + aaVarB.f() + "&sdk_version=" + aaVarB.h + "&event_code=" + cVar.b + "&event_result=" + (cVar.d ? 1 : 0) + "&event_time=" + this.a.format(new Date(cVar.c)) + "&event_cost=" + cVar.e + "&device_id=" + aaVarB.g() + "&debug=" + (aaVarB.D ? 1 : 0) + "&param_0=" + cVar.f + "&param_1=" + cVar.a + "&param_2=" + (aaVarB.M ? "rqd" : "ext") + "&param_4=" + aaVarB.e();
