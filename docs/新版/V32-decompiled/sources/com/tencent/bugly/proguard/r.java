...
public final class r {
    ...
    public final void a() {
        ...
        ak.a().a(new b(), (this.b - System.currentTimeMillis()) + TimedRemoteCaller.DEFAULT_CALL_TIMEOUT_MILLIS);
    }
    ...
    class b implements Runnable {
        ...
        public final void run() {
            ...
            if (jCurrentTimeMillis < r.this.b) {
                ak.a().a(r.this.new b(), (r.this.b - jCurrentTimeMillis) + TimedRemoteCaller.DEFAULT_CALL_TIMEOUT_MILLIS);
            } else {
                r.this.a(3, false);
                r.this.a();
            }
