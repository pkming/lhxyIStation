...
public interface IHardwareService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IHardwareService {
        ...
        public static IHardwareService asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IHardwareService)) {
                return (IHardwareService) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                parcel2.writeInt(flashlightEnabled ? 1 : 0);
                return true;
            }
            if (i != 2) {
                if (i == 1598968902) {
