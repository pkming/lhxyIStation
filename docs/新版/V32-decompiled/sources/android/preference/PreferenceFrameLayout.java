...
public class PreferenceFrameLayout extends FrameLayout {
    ...
    public PreferenceFrameLayout(Context context, AttributeSet attributeSet) {
        this(context, attributeSet, 16843806);
    }

    public PreferenceFrameLayout(Context context, AttributeSet attributeSet, int i) {
        super(context, attributeSet, i);
        TypedArray typedArrayObtainStyledAttributes = context.obtainStyledAttributes(attributeSet, R.styleable.PreferenceFrameLayout, i, 0);
        int i2 = (int) ((context.getResources().getDisplayMetrics().density * 0.0f) + 0.5f);
        this.mBorderTop = typedArrayObtainStyledAttributes.getDimensionPixelSize(0, i2);
        this.mBorderBottom = typedArrayObtainStyledAttributes.getDimensionPixelSize(1, i2);
        this.mBorderLeft = typedArrayObtainStyledAttributes.getDimensionPixelSize(2, i2);
        this.mBorderRight = typedArrayObtainStyledAttributes.getDimensionPixelSize(3, i2);
