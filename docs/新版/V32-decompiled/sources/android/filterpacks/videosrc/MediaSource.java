...
public class MediaSource extends Filter {
    ...
    protected void prepare(FilterContext filterContext) {
        ...
        ShaderProgram shaderProgram = new ShaderProgram(filterContext, "#extension GL_OES_EGL_image_external : require\nprecision mediump float;\nuniform samplerExternalOES tex_sampler_0;\nvarying vec2 v_texcoord;\nvoid main() {\n  gl_FragColor = texture2D(tex_sampler_0, v_texcoord);\n}\n");
    ...
    public void process(FilterContext filterContext) {
        ...
        Objects.requireNonNull(this.mMediaPlayer, "Unexpected null media player!");
        if (this.mCompleted) {
    ...
    public void fieldPortValueUpdated(String str, FilterContext filterContext) {
        ...
        if (str.equals(MediaStore.Images.ImageColumns.ORIENTATION) && this.mGotSize) {
