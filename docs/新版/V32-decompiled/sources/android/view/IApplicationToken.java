...
public interface IApplicationToken extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IApplicationToken {
        ...
        public static IApplicationToken asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IApplicationToken)) {
                return (IApplicationToken) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 4) {
                parcel.enforceInterface(DESCRIPTOR);
                boolean zKeyDispatchingTimedOut = keyDispatchingTimedOut(parcel.readString());
                parcel2.writeNoException();
                parcel2.writeInt(zKeyDispatchingTimedOut ? 1 : 0);
                return true;
            }
            if (i != 5) {
                if (i == 1598968902) {
