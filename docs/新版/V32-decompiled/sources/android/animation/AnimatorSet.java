...
public final class AnimatorSet extends Animator {
    ...
    public AnimatorSet mo0clone() {
        AnimatorSet animatorSet = (AnimatorSet) super.mo0clone();
        ...
        for (Node node : this.mNodes) {
            ...
            animatorSet.mNodeMap.put(nodeM1clone.animation, nodeM1clone);
            ArrayList arrayList = null;
            nodeM1clone.dependencies = null;
            nodeM1clone.tmpDependencies = null;
            nodeM1clone.nodeDependents = null;
            nodeM1clone.nodeDependencies = null;
            ArrayList<Animator.AnimatorListener> listeners = nodeM1clone.animation.getListeners();
            if (listeners != null) {
