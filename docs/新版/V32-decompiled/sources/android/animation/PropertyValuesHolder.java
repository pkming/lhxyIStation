...
public class PropertyValuesHolder implements Cloneable {
    ...
    private Method getPropertyFunction(Class cls, String str, Class cls2) {
        ...
        if (method == null) {
            Log.w("PropertyValuesHolder", "Method " + getMethodName(str, this.mPropertyName) + "() with type " + this.mValueType + " not found on target class " + cls);
        }
        return method;
    }
    ...
    static class IntPropertyValuesHolder extends PropertyValuesHolder {
        ...
        void setAnimatedValue(Object obj) {
            ...
            int i = this.mJniSetter;
            if (i != 0) {
                PropertyValuesHolder.nCallIntMethod(obj, i, this.mIntAnimatedValue);
                return;
            }
            if (this.mSetter != null) {
                try {
        ...
        void setupSetter(Class cls) {
            ...
            try {
                this.mPropertyMapLock.writeLock().lock();
                HashMap<Class, HashMap<String, Integer>> map = sJNISetterPropertyMap;
                HashMap<String, Integer> map2 = map.get(cls);
                if (map2 != null && (num = map2.get(this.mPropertyName)) != null) {
                    this.mJniSetter = num.intValue();
                }
                if (this.mJniSetter == 0) {
                    int iNGetIntMethod = PropertyValuesHolder.nGetIntMethod(cls, getMethodName("set", this.mPropertyName));
                    this.mJniSetter = iNGetIntMethod;
                    if (iNGetIntMethod != 0) {
                        if (map2 == null) {
                            map2 = new HashMap<>();
                            map.put(cls, map2);
                        }
                        map2.put(this.mPropertyName, Integer.valueOf(this.mJniSetter));
                    }
                }
    ...
    static class FloatPropertyValuesHolder extends PropertyValuesHolder {
        ...
        void setAnimatedValue(Object obj) {
            ...
            int i = this.mJniSetter;
            if (i != 0) {
                PropertyValuesHolder.nCallFloatMethod(obj, i, this.mFloatAnimatedValue);
                return;
            }
            if (this.mSetter != null) {
                try {
        ...
        void setupSetter(Class cls) {
            ...
            try {
                ...
                if (this.mJniSetter == 0) {
                    int iNGetFloatMethod = PropertyValuesHolder.nGetFloatMethod(cls, getMethodName("set", this.mPropertyName));
                    this.mJniSetter = iNGetFloatMethod;
                    if (iNGetFloatMethod != 0) {
                        if (map2 == null) {
                            map2 = new HashMap<>();
                            map.put(cls, map2);
                        }
