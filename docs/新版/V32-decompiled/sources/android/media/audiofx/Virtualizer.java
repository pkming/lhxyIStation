    ...
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(AudioEffect audioEffect, int i, byte[] bArr, byte[] bArr2) {
            ...
            if (onParameterChangeListener != null) {
                int iByteArrayToInt = bArr.length == 4 ? Virtualizer.this.byteArrayToInt(bArr, 0) : -1;
                short sByteArrayToShort = bArr2.length == 2 ? Virtualizer.this.byteArrayToShort(bArr2, 0) : (short) -1;
