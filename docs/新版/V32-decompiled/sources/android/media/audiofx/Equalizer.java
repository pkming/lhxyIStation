    ...
    private class BaseParameterListener implements AudioEffect.OnParameterChangeListener {
        ...
        public void onParameterChange(AudioEffect audioEffect, int i, byte[] bArr, byte[] bArr2) {
            ...
            if (onParameterChangeListener != null) {
                if (bArr.length >= 4) {
                    int iByteArrayToInt3 = Equalizer.this.byteArrayToInt(bArr, 0);
                    if (bArr.length >= 8) {
                        i2 = iByteArrayToInt3;
                        iByteArrayToInt = Equalizer.this.byteArrayToInt(bArr, 4);
                    } else {
                        i2 = iByteArrayToInt3;
                        iByteArrayToInt = -1;
                    }
                ...
                if (bArr2.length == 2) {
                    iByteArrayToInt2 = Equalizer.this.byteArrayToShort(bArr2, 0);
                } else {
                    if (bArr2.length != 4) {
                        i3 = -1;
                        if (i2 != -1 || i3 == -1) {
                    ...
                    iByteArrayToInt2 = Equalizer.this.byteArrayToInt(bArr2, 0);
                }
                i3 = iByteArrayToInt2;
                if (i2 != -1) {
                }
        ...
        public Settings(String str) {
            ...
            try {
                ...
                while (i < this.numBands) {
                    ...
                    int i3 = i + 1;
                    if (!strNextToken4.equals("band" + i3 + "Level")) {
