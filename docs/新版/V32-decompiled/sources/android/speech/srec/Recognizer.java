...
public final class Recognizer {
    ...
    public static String getConfigDir(Locale locale) {
        ...
        String str = "/system/usr/srec/config/" + locale.toString().replace('_', '.').toLowerCase(Locale.ROOT);
    ...
    public Recognizer(String str) throws IOException {
        ...
        int iSR_RecognizerCreate = SR_RecognizerCreate();
        this.mRecognizer = iSR_RecognizerCreate;
        SR_RecognizerSetup(iSR_RecognizerCreate);
    ...
    public class Grammar {
        ...
        public Grammar(String str) throws IOException {
            this.mGrammar = 0;
            int iSR_GrammarLoad = Recognizer.SR_GrammarLoad(str);
            this.mGrammar = iSR_GrammarLoad;
            Recognizer.SR_GrammarSetupVocabulary(iSR_GrammarLoad, Recognizer.this.mVocabulary);
        }
        ...
        public void destroy() {
            int i = this.mGrammar;
            if (i != 0) {
                Recognizer.SR_GrammarDestroy(i);
                this.mGrammar = 0;
            }
        }
    ...
    public void putAudio(InputStream inputStream) throws IOException {
        ...
        int i = inputStream.read(this.mPutAudioBuffer);
        if (i == -1) {
            SR_RecognizerPutAudio(this.mRecognizer, this.mPutAudioBuffer, 0, 0, true);
        } else if (i != SR_RecognizerPutAudio(this.mRecognizer, this.mPutAudioBuffer, 0, i, false)) {
    ...
    public void destroy() {
        try {
            int i = this.mVocabulary;
            if (i != 0) {
                SR_VocabularyDestroy(i);
            }
            this.mVocabulary = 0;
            try {
                int i2 = this.mRecognizer;
                if (i2 != 0) {
                    SR_RecognizerUnsetup(i2);
                }
                try {
                    int i3 = this.mRecognizer;
                    if (i3 != 0) {
                        SR_RecognizerDestroy(i3);
                    }
                    this.mRecognizer = 0;
                    try {
                        SR_SessionDestroy();
                ...
                try {
                    int i4 = this.mRecognizer;
                    if (i4 != 0) {
                        SR_RecognizerDestroy(i4);
                    }
                    this.mRecognizer = 0;
                    try {
                        SR_SessionDestroy();
            ...
            this.mVocabulary = 0;
            try {
                int i5 = this.mRecognizer;
                if (i5 != 0) {
                    SR_RecognizerUnsetup(i5);
                }
                try {
                    int i6 = this.mRecognizer;
                    if (i6 != 0) {
                        SR_RecognizerDestroy(i6);
                    }
                    this.mRecognizer = 0;
                    try {
                        SR_SessionDestroy();
                ...
                try {
                    int i7 = this.mRecognizer;
                    if (i7 != 0) {
                        SR_RecognizerDestroy(i7);
                    }
                    this.mRecognizer = 0;
                    try {
                        SR_SessionDestroy();
