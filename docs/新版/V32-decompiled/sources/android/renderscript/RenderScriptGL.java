...
public class RenderScriptGL extends RenderScript {
    ...
    public void setSurfaceTexture(SurfaceTexture surfaceTexture, int i, int i2) {
        ...
        this.mWidth = i;
        this.mHeight = i2;
        nContextSetSurfaceTexture(i, i2, surfaceTexture);
    }
