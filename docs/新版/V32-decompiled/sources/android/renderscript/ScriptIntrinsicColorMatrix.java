...
public final class ScriptIntrinsicColorMatrix extends ScriptIntrinsic {
    ...
    private ScriptIntrinsicColorMatrix(int i, RenderScript renderScript) {
    ...
    public static ScriptIntrinsicColorMatrix create(RenderScript renderScript) {
        return new ScriptIntrinsicColorMatrix(renderScript.nScriptIntrinsicCreate(2, 0), renderScript);
    }
