...
public class Program extends BaseObj {
    ...
    public void bindConstants(Allocation allocation, int i) {
        ...
        this.mRS.nProgramBindConstants(getID(this.mRS), i, allocation != null ? allocation.getID(this.mRS) : 0);
    }
    ...
    public void bindTexture(Allocation allocation, int i) throws IllegalArgumentException {
        ...
        this.mRS.nProgramBindTexture(getID(this.mRS), i, allocation != null ? allocation.getID(this.mRS) : 0);
    }
    ...
    public void bindSampler(Sampler sampler, int i) throws IllegalArgumentException {
        ...
        this.mRS.nProgramBindSampler(getID(this.mRS), i, sampler != null ? sampler.getID(this.mRS) : 0);
    }
