...
public class ContentProviderOperation implements Parcelable {
    ...
    private ContentProviderOperation(Parcel parcel) {
        ...
        HashMap map = parcel.readInt() != 0 ? new HashMap() : null;
    ...
    public static class Builder {
        ...
        public ContentProviderOperation build() {
            ...
            if (this.mType == 2 && (((contentValues3 = this.mValues) == null || contentValues3.size() == 0) && ((contentValues4 = this.mValuesBackReferences) == null || contentValues4.size() == 0))) {
                throw new IllegalArgumentException("Empty values");
            }
            if (this.mType == 4 && (((contentValues = this.mValues) == null || contentValues.size() == 0) && (((contentValues2 = this.mValuesBackReferences) == null || contentValues2.size() == 0) && this.mExpectedCount == null))) {
                throw new IllegalArgumentException("Empty values");
            }
