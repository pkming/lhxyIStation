    ...
    public CharSequence get(int i) {
        synchronized (this) {
            ...
            if (charSequenceArr2 != null) {
                charSequenceArr2[i] = strApplyStyles;
            } else {
        ...
        if (!TextUtils.isEmpty(str)) {
            if (str.startsWith("@")) {
                ...
                if (identifier != 0) {
                    ...
                    htmlColor = colorStateList.getDefaultColor();
                }
            } else {
                htmlColor = Color.getHtmlColor(str);
            }
        }
        if (z) {
            return new ForegroundColorSpan(htmlColor);
        }
        return new BackgroundColorSpan(htmlColor);
    }
