...
public final class BluetoothClass implements Parcelable {
    ...
    public boolean equals(Object obj) {
        return (obj instanceof BluetoothClass) && this.mClass == ((BluetoothClass) obj).mClass;
    }
    ...
    public boolean hasService(int i) {
        return (i & (this.mClass & 16769024)) != 0;
    }
    ...
    public boolean doesClassMatch(int i) {
        ...
        int deviceClass2;
        if (i == 1) {
            return hasService(262144) || (deviceClass2 = getDeviceClass()) == 1044 || deviceClass2 == 1048 || deviceClass2 == 1056 || deviceClass2 == 1064;
        }
        if (i == 0) {
