...
public interface IBluetoothInputDevice extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IBluetoothInputDevice {
        ...
        public static IBluetoothInputDevice asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IBluetoothInputDevice)) {
                return (IBluetoothInputDevice) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 8:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(protocolMode ? 1 : 0);
                    return true;
                case 9:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zVirtualUnplug = virtualUnplug(parcel.readInt() != 0 ? BluetoothDevice.CREATOR.createFromParcel(parcel) : null);
                    parcel2.writeNoException();
                    parcel2.writeInt(zVirtualUnplug ? 1 : 0);
                    return true;
                case 10:
                    parcel.enforceInterface(DESCRIPTOR);
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(protocolMode2 ? 1 : 0);
                    return true;
                case 11:
                    parcel.enforceInterface(DESCRIPTOR);
                ...
                case 12:
                    ...
                    parcel2.writeNoException();
                    parcel2.writeInt(report2 ? 1 : 0);
                    return true;
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    boolean zSendData = sendData(parcel.readInt() != 0 ? BluetoothDevice.CREATOR.createFromParcel(parcel) : null, parcel.readString());
                    parcel2.writeNoException();
                    parcel2.writeInt(zSendData ? 1 : 0);
                    return true;
                default:
