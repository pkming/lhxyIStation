...
public final class R {
    ...
    public static final class array {
        ...
        public static final int support_tv_format_entries_av = 0x0107003b;
        public static final int support_tv_format_entries_hdmi = 0x0107003a;
        public static final int support_tv_format_values_av = 0x01070039;
        public static final int support_tv_format_values_hdmi = 0x01070038;
    }
    ...
    public static final class styleable {
        ...
        public static final int[] AlertDialog = {R.attr.fullDark, R.attr.topDark, R.attr.centerDark, R.attr.bottomDark, R.attr.fullBright, R.attr.topBright, R.attr.centerBright, R.attr.bottomBright, R.attr.bottomMedium, R.attr.centerMedium, R.attr.layout, 16843816, 16843817, 16843818, 16843819, 16843820, 16843821};
        ...
        public static final int[] AndroidManifest = {R.attr.sharedUserId, R.attr.versionCode, R.attr.versionName, R.attr.sharedUserLabel, R.attr.installLocation};
        ...
        public static final int[] AndroidManifestActivityAlias = {R.attr.label, R.attr.icon, R.attr.name, R.attr.permission, R.attr.enabled, R.attr.exported, R.attr.description, R.attr.targetActivity, R.attr.logo, R.attr.parentActivityName};
        public static final int[] AndroidManifestApplication = {R.attr.theme, R.attr.label, R.attr.icon, R.attr.name, R.attr.manageSpaceActivity, R.attr.allowClearUserData, R.attr.permission, R.attr.hasCode, R.attr.persistent, R.attr.enabled, R.attr.debuggable, R.attr.process, R.attr.taskAffinity, R.attr.description, R.attr.allowTaskReparenting, R.attr.testOnly, R.attr.backupAgent, R.attr.allowBackup, R.attr.killAfterRestore, R.attr.restoreNeedsApplication, R.attr.vmSafeMode, R.attr.restoreAnyVersion, R.attr.logo, R.attr.hardwareAccelerated, R.attr.largeHeap, R.attr.uiOptions, R.attr.supportsRtl, R.attr.requiredForAllUsers, R.attr.restrictedAccountType, R.attr.requiredAccountType, 16843902, 16843903};
        ...
        public static final int[] AndroidManifestInstrumentation = {R.attr.label, R.attr.icon, R.attr.name, R.attr.targetPackage, R.attr.handleProfiling, R.attr.functionalTest, R.attr.logo};
        public static final int[] AndroidManifestIntentFilter = {R.attr.label, R.attr.icon, R.attr.priority, R.attr.logo};
        ...
        public static final int[] AndroidManifestPermission = {R.attr.label, R.attr.icon, R.attr.name, R.attr.protectionLevel, R.attr.permissionGroup, R.attr.description, R.attr.logo, R.attr.permissionFlags};
        public static final int[] AndroidManifestPermissionGroup = {R.attr.label, R.attr.icon, R.attr.name, R.attr.priority, R.attr.description, R.attr.logo, R.attr.permissionGroupFlags};
        public static final int[] AndroidManifestPermissionTree = {R.attr.label, R.attr.icon, R.attr.name, R.attr.logo};
        public static final int[] AndroidManifestProtectedBroadcast = {R.attr.name};
        public static final int[] AndroidManifestProvider = {R.attr.label, R.attr.icon, R.attr.name, R.attr.permission, R.attr.readPermission, R.attr.writePermission, R.attr.enabled, R.attr.exported, R.attr.process, R.attr.multiprocess, R.attr.authorities, R.attr.syncable, R.attr.initOrder, R.attr.grantUriPermissions, R.attr.description, R.attr.logo, R.attr.singleUser};
        public static final int[] AndroidManifestReceiver = {R.attr.label, R.attr.icon, R.attr.name, R.attr.permission, R.attr.enabled, R.attr.exported, R.attr.process, R.attr.description, R.attr.logo, R.attr.singleUser};
        public static final int[] AndroidManifestService = {R.attr.label, R.attr.icon, R.attr.name, R.attr.permission, R.attr.enabled, R.attr.exported, R.attr.process, R.attr.description, R.attr.logo, R.attr.stopWithTask, R.attr.isolatedProcess, R.attr.singleUser};
        ...
        public static final int[] AnimatedRotateDrawable = {R.attr.visible, R.attr.drawable, R.attr.pivotX, R.attr.pivotY, 16843850, 16843851};
        ...
        public static final int[] BitmapDrawable = {R.attr.gravity, R.attr.src, R.attr.antialias, R.attr.filter, R.attr.dither, R.attr.tileMode, R.attr.mipMap, R.attr.autoMirrored};
        ...
        public static final int[] DatePicker = {R.attr.startYear, R.attr.endYear, R.attr.minDate, R.attr.maxDate, R.attr.spinnersShown, R.attr.calendarViewShown, 16843836};
        ...
        public static final int[] FragmentBreadCrumbs = {R.attr.gravity};
        public static final int[] FrameLayout = {R.attr.foreground, R.attr.measureAllChildren, R.attr.foregroundGravity, 16843822};
        ...
        public static final int[] GlowPadView = {R.attr.gravity, R.attr.innerRadius, R.attr.targetDescriptions, R.attr.directionDescriptions, 16843856, 16843857, 16843858, 16843859, 16843860, 16843861, 16843862, 16843863, 16843866, 16843867, 16843868, 16843869, 16843870};
        public static final int[] GradientDrawable = {R.attr.dither, R.attr.visible, R.attr.shape, R.attr.innerRadiusRatio, R.attr.thicknessRatio, R.attr.useLevel, R.attr.innerRadius, R.attr.thickness};
        ...
        public static final int[] IconMenuView = {R.attr.rowHeight, R.attr.maxRows, R.attr.maxItemsPerRow, R.attr.moreIcon, 16843830};
        public static final int[] ImageSwitcher = new int[0];
        public static final int[] ImageView = {R.attr.src, R.attr.scaleType, R.attr.adjustViewBounds, R.attr.maxWidth, R.attr.maxHeight, R.attr.tint, R.attr.baselineAlignBottom, R.attr.cropToPadding, R.attr.baseline, 16843823};
        ...
        public static final int[] KeySet = {R.attr.name};
        ...
        public static final int[] KeyboardView = {R.attr.shadowColor, R.attr.shadowRadius, R.attr.keyBackground, R.attr.keyTextSize, R.attr.labelTextSize, R.attr.keyTextColor, R.attr.keyPreviewLayout, R.attr.keyPreviewOffset, R.attr.keyPreviewHeight, R.attr.verticalCorrection, R.attr.popupLayout, 16843855};
        ...
        public static final int[] LayerDrawable = {R.attr.opacity, R.attr.autoMirrored};
        ...
        public static final int[] MediaRouteButton = {R.attr.minWidth, R.attr.minHeight, R.attr.mediaRouteTypes, 16843889};
        ...
        public static final int[] MenuView = {R.attr.windowAnimationStyle, R.attr.itemTextAppearance, R.attr.horizontalDivider, R.attr.verticalDivider, R.attr.headerBackground, R.attr.itemBackground, R.attr.itemIconDisabledAlpha, 16843829};
        public static final int[] MultiPaneChallengeLayout = {R.attr.orientation};
        public static final int[] MultiPaneChallengeLayout_Layout = {R.attr.layout_gravity, 16843871, 16843897, 16843898, 16843899};
        public static final int[] MultiSelectListPreference = {R.attr.entries, R.attr.entryValues};
        public static final int[] MultiWaveView = {R.attr.targetDescriptions, R.attr.directionDescriptions, 16843862, 16843863, 16843864, 16843865, 16843866, 16843867, 16843868, 16843869, 16843870};
        public static final int[] NinePatchDrawable = {R.attr.src, R.attr.dither, R.attr.autoMirrored};
        public static final int[] NumPadKey = {16843900, 16843901};
        public static final int[] NumberPicker = {R.attr.solidColor, 16843836, 16843842, 16843843, 16843844, 16843845, 16843846, 16843847, 16843848, 16843849};
        ...
        public static final int[] ShapeDrawable = {R.attr.dither, R.attr.height, R.attr.width, R.attr.color};
        ...
        public static final int[] Spinner = {R.attr.gravity, R.attr.dropDownSelector, R.attr.popupBackground, R.attr.prompt, R.attr.dropDownWidth, R.attr.dropDownHorizontalOffset, R.attr.dropDownVerticalOffset, R.attr.spinnerMode, 16843834, 16843835};
        ...
        public static final int[] Switch = {R.attr.textOn, R.attr.textOff, R.attr.thumb, R.attr.switchTextAppearance, R.attr.track, R.attr.switchMinWidth, R.attr.switchPadding, R.attr.thumbTextPadding};
        ...
        public static final int[] TabWidget = {R.attr.divider, R.attr.tabStripLeft, R.attr.tabStripRight, R.attr.tabStripEnabled, 16843833};
        ...
        public static final int[] Transition = {R.attr.interpolator, R.attr.duration, R.attr.startDelay};
        ...
        public static final int[] ViewGroup = {R.attr.clipChildren, R.attr.clipToPadding, R.attr.layoutAnimation, R.attr.animationCache, R.attr.persistentDrawingCache, R.attr.alwaysDrawnWithCache, R.attr.addStatesFromChildren, R.attr.descendantFocusability, R.attr.splitMotionEvents, R.attr.animateLayoutChanges, R.attr.layoutMode};
        ...
        public static final int[] Window = {R.attr.backgroundDimAmount, R.attr.windowBackground, R.attr.windowFrame, R.attr.windowNoTitle, R.attr.windowIsFloating, R.attr.windowIsTranslucent, R.attr.windowContentOverlay, R.attr.textColor, R.attr.windowAnimationStyle, R.attr.windowFullscreen, R.attr.windowNoDisplay, R.attr.backgroundDimEnabled, R.attr.windowDisablePreview, R.attr.windowSoftInputMode, R.attr.windowShowWallpaper, R.attr.windowActionBar, R.attr.windowActionModeOverlay, R.attr.windowActionBarOverlay, R.attr.windowEnableSplitTouch, R.attr.windowMinWidthMajor, R.attr.windowMinWidthMinor, R.attr.windowCloseOnTouchOutside, R.attr.windowOverscan, R.attr.windowTranslucentStatus, R.attr.windowTranslucentNavigation, 16843770, 16843812, 16843813, 16843814, 16843815};
