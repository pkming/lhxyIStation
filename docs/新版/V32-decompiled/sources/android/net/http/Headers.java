        ...
        switch (strSubstringTrimmed.hashCode()) {
            case HASH_X_PERMITTED_CROSS_DOMAIN_POLICIES /* -1345594014 */:
                if (strSubstringTrimmed.equals(X_PERMITTED_CROSS_DOMAIN_POLICIES)) {
                    this.mHeaders[18] = strSubstringTrimmed2;
                }
                break;
            case HASH_EXPIRES /* -1309235404 */:
                if (strSubstringTrimmed.equals(EXPIRES)) {
                    this.mHeaders[11] = strSubstringTrimmed2;
                }
                break;
            ...
            case HASH_PROXY_AUTHENTICATE /* -301767724 */:
                if (strSubstringTrimmed.equals(PROXY_AUTHENTICATE)) {
                    this.mHeaders[8] = strSubstringTrimmed2;
                }
                break;
            ...
            case HASH_CACHE_CONTROL /* -208775662 */:
                if (strSubstringTrimmed.equals(CACHE_CONTROL)) {
                    ...
                    if (strArr[12] != null && strArr[12].length() > 0) {
                        ...
                        strArr2[12] = sb.append(strArr2[12]).append(PhoneNumberUtils.PAUSE).append(strSubstringTrimmed2).toString();
                    } else {
                        this.mHeaders[12] = strSubstringTrimmed2;
                    }
                }
                break;
            case HASH_ETAG /* 3123477 */:
                if (strSubstringTrimmed.equals(ETAG)) {
                    this.mHeaders[14] = strSubstringTrimmed2;
                }
                break;
            ...
            case HASH_SET_COOKIE /* 1237214767 */:
                if (strSubstringTrimmed.equals(SET_COOKIE)) {
                    this.mHeaders[15] = strSubstringTrimmed2;
