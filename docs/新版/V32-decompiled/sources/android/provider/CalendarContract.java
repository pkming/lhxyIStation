    ...
    public static final class EventsEntity implements BaseColumns, SyncColumns, EventsColumns {
        ...
        private static class EntityIteratorImpl extends CursorEntityIterator {
            ...
            public Entity getEntityAndIncrementCursor(Cursor cursor) throws RemoteException {
                ...
                DatabaseUtils.cursorIntToContentValuesIfPresent(cursor, contentValues, EventsColumns.AVAILABILITY);
                ...
                while (cursorQuery2.moveToNext()) {
                    try {
                        ...
                        contentValues2.put("method", Integer.valueOf(cursorQuery2.getInt(1)));
                ...
                if (contentResolver2 != null) {
                    cursorQuery3 = contentResolver2.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(j)}, null);
                } else {
                    cursorQuery3 = this.mProvider.query(Attendees.CONTENT_URI, ATTENDEES_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(j)}, null);
                }
                while (cursorQuery2.moveToNext()) {
                    try {
                ...
                if (contentResolver3 != null) {
                    cursorQuery2 = contentResolver3.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(j)}, null);
                } else {
                    cursorQuery2 = this.mProvider.query(ExtendedProperties.CONTENT_URI, EXTENDED_PROJECTION, WHERE_EVENT_ID, new String[]{Long.toString(j)}, null);
                }
                while (cursorQuery2.moveToNext()) {
                    try {
        ...
        */
        public static final long findNextAlarmTime(android.content.ContentResolver r7, long r8) {
            /*
                ...
                if (r7 == 0) goto L41
                boolean r8 = r7.moveToFirst()     // Catch: java.lang.Throwable -> L3a
                if (r8 == 0) goto L41
                long r8 = r7.getLong(r9)     // Catch: java.lang.Throwable -> L3a
                goto L43
            L3a:
                r8 = move-exception
                if (r7 == 0) goto L40
