...
public class Contacts {
    ...
    public static final class People implements BaseColumns, SyncConstValue, PeopleColumns, PhonesColumns, PresenceColumns {
        ...
        public static void markAsContacted(ContentResolver contentResolver, long j) {
            Uri uriWithAppendedPath = Uri.withAppendedPath(ContentUris.withAppendedId(CONTENT_URI, j), "update_contact_time");
            ContentValues contentValues = new ContentValues();
    ...
    public static final class ContactMethods implements BaseColumns, ContactMethodsColumns, PeopleColumns {
        ...
        */
        public static final java.lang.CharSequence getDisplayLabel(android.content.Context r3, int r4, int r5, java.lang.CharSequence r6) {
            /*
                r0 = 0
                r1 = 1
                if (r4 == r1) goto L2b
            ...
            Lf:
                ...
                r4 = 17235972(0x1070004, float:2.4795595E-38)
                java.lang.CharSequence[] r3 = r3.getTextArray(r4)
                int r5 = r5 - r1
                r3 = r3[r5]     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L21
            L1f:
                r6 = r3
                goto L47
            L21:
            ...
            L2b:
                if (r5 == 0) goto L3e
                android.content.res.Resources r3 = r3.getResources()
                r4 = 17235968(0x1070000, float:2.4795584E-38)
                java.lang.CharSequence[] r3 = r3.getTextArray(r4)
                int r5 = r5 - r1
                r3 = r3[r5]     // Catch: java.lang.ArrayIndexOutOfBoundsException -> L3b
                goto L1f
            L3b:
                r3 = r3[r0]
                goto L1f
    ...
    public static final class Presence implements BaseColumns, PresenceColumns, PeopleColumns {
        ...
        @Deprecated
        public static final void setPresenceIcon(ImageView imageView, int i) throws Throwable {
    ...
    public static final class Organizations implements BaseColumns, OrganizationColumns {
        ...
        public static final CharSequence getDisplayLabel(Context context, int i, CharSequence charSequence) {
            ...
            CharSequence[] textArray = context.getResources().getTextArray(R.array.organizationTypes);
            try {
