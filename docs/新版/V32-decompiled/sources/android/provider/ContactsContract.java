...
public final class ContactsContract {
    ...
    public static class Contacts implements BaseColumns, ContactsColumns, ContactOptionsColumns, ContactNameColumns, ContactStatusColumns {
        ...
        static {
            ...
            CONTENT_LOOKUP_URI = Uri.withAppendedPath(uriWithAppendedPath, ContactsColumns.LOOKUP_KEY);
            ...
            CONTENT_FREQUENT_URI = Uri.withAppendedPath(uriWithAppendedPath, "frequent");
            CONTENT_STREQUENT_FILTER_URI = Uri.withAppendedPath(uriWithAppendedPath2, "filter");
            CONTENT_GROUP_URI = Uri.withAppendedPath(uriWithAppendedPath, WifiConfiguration.GroupCipher.varName);
        }

        public static Uri getLookupUri(ContentResolver contentResolver, Uri uri) {
            Cursor cursorQuery = contentResolver.query(uri, new String[]{ContactsColumns.LOOKUP_KEY, "_id"}, null, null, null);
            if (cursorQuery == null) {
                return null;
            }
            try {
        ...
        public static void markAsContacted(ContentResolver contentResolver, long j) {
            Uri uriWithAppendedId = ContentUris.withAppendedId(CONTENT_URI, j);
            ...
            public static final class Builder {
                ...
                public Uri build() {
                    ...
                    for (int i2 = 0; i2 < size; i2++) {
                        builderBuildUpon.appendQueryParameter("query", this.mKinds.get(i2) + ":" + this.mValues.get(i2));
                    }
        ...
        public static InputStream openContactPhotoInputStream(ContentResolver contentResolver, Uri uri, boolean z) {
            if (z) {
                try {
                    return contentResolver.openAssetFileDescriptor(Uri.withAppendedPath(uri, "display_photo"), FullBackup.ROOT_TREE_TOKEN).createInputStream();
    ...
    public static final class RawContacts implements BaseColumns, RawContactsColumns, ContactOptionsColumns, ContactNameColumns, SyncColumns {
        ...
        public static Uri getContactLookupUri(ContentResolver contentResolver, Uri uri) {
            Cursor cursorQuery = contentResolver.query(Uri.withAppendedPath(uri, "data"), new String[]{"contact_id", ContactsColumns.LOOKUP_KEY}, null, null, null);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.moveToFirst()) {
    ...
    public static final class Data implements DataColumnsWithJoins {
        ...
        public static Uri getContactLookupUri(ContentResolver contentResolver, Uri uri) {
            Cursor cursorQuery = contentResolver.query(uri, new String[]{"contact_id", ContactsColumns.LOOKUP_KEY}, null, null, null);
            if (cursorQuery != null) {
                try {
                    if (cursorQuery.moveToFirst()) {
                        Uri lookupUri = Contacts.getLookupUri(cursorQuery.getLong(0), cursorQuery.getString(1));
    ...
    public static final class CommonDataKinds {
        ...
        public static final class Event implements DataColumnsWithJoins, CommonColumns {
            ...
            public static int getTypeResource(Integer num) {
                ...
                if (iIntValue != 2) {
                    return iIntValue != 3 ? 17040079 : 17040080;
                }
                return 17040082;
            }
        }
    ...
    public static final class QuickContact {
        ...
        public static Intent composeQuickContactsIntent(Context context, Rect rect, Uri uri, int i, String[] strArr) {
            ...
            Intent intentAddFlags = new Intent(ACTION_QUICK_CONTACT).addFlags(context instanceof Activity ? 524288 : 268468224);
            intentAddFlags.setData(uri);
            intentAddFlags.setSourceBounds(rect);
            intentAddFlags.putExtra("mode", i);
            intentAddFlags.putExtra("exclude_mimes", strArr);
            return intentAddFlags;
        }

        public static void showQuickContact(Context context, View view, Uri uri, int i, String[] strArr) {
            context.startActivity(composeQuickContactsIntent(context, view, uri, i, strArr));
        }

        public static void showQuickContact(Context context, Rect rect, Uri uri, int i, String[] strArr) {
            context.startActivity(composeQuickContactsIntent(context, rect, uri, i, strArr));
        }
    }
