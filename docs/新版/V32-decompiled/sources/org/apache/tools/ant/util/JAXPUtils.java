...
public class JAXPUtils {
    ...
    public static synchronized SAXParserFactory getNSParserFactory() throws BuildException {
        if (nsParserFactory == null) {
            SAXParserFactory sAXParserFactoryNewParserFactory = newParserFactory();
            nsParserFactory = sAXParserFactoryNewParserFactory;
            sAXParserFactoryNewParserFactory.setNamespaceAware(true);
        }
