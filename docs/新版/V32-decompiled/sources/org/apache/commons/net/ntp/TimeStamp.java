...
public class TimeStamp implements Serializable, Comparable<TimeStamp> {
    ...
    public long getSeconds() {
        return (this.ntpTime >>> 32) & ExpandableListView.PACKED_POSITION_VALUE_NULL;
    }

    public long getFraction() {
        return this.ntpTime & ExpandableListView.PACKED_POSITION_VALUE_NULL;
    }
    ...
    public static long getTime(long j) {
        long j2 = (j >>> 32) & ExpandableListView.PACKED_POSITION_VALUE_NULL;
        return (j2 * 1000) + ((VideoEditor.MAX_SUPPORTED_FILE_SIZE & j2) == 0 ? msb0baseTime : msb1baseTime) + Math.round(((j & ExpandableListView.PACKED_POSITION_VALUE_NULL) * 1000.0d) / 4.294967296E9d);
    }
    ...
    protected static long toNtpTime(long j) {
        ...
        if (z) {
            j4 |= VideoEditor.MAX_SUPPORTED_FILE_SIZE;
        }
        return j5 | (j4 << 32);
    }
    ...
    public static String toString(long j) {
        ...
        appendHexString(sb, (j >>> 32) & ExpandableListView.PACKED_POSITION_VALUE_NULL);
        sb.append('.');
        appendHexString(sb, j & ExpandableListView.PACKED_POSITION_VALUE_NULL);
        return sb.toString();
    }
