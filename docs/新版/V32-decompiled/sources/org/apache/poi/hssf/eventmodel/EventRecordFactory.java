...
public class EventRecordFactory {
    ...
    static {
        ...
        Class clsClass$66 = class$org$apache$poi$hssf$record$BoolErrRecord;
        if (clsClass$66 == null) {
            clsClass$66 = class$("org.apache.poi.hssf.record.BoolErrRecord");
            class$org$apache$poi$hssf$record$BoolErrRecord = clsClass$66;
        }
        clsArr[65] = clsClass$66;
        Class clsClass$67 = class$org$apache$poi$hssf$record$ExternSheetRecord;
        if (clsClass$67 == null) {
            clsClass$67 = class$("org.apache.poi.hssf.record.ExternSheetRecord");
            class$org$apache$poi$hssf$record$ExternSheetRecord = clsClass$67;
        }
        clsArr[66] = clsClass$67;
        Class clsClass$68 = class$org$apache$poi$hssf$record$NameRecord;
        if (clsClass$68 == null) {
            clsClass$68 = class$("org.apache.poi.hssf.record.NameRecord");
            class$org$apache$poi$hssf$record$NameRecord = clsClass$68;
        }
        clsArr[67] = clsClass$68;
        Class clsClass$69 = class$org$apache$poi$hssf$record$LeftMarginRecord;
        if (clsClass$69 == null) {
            clsClass$69 = class$("org.apache.poi.hssf.record.LeftMarginRecord");
            class$org$apache$poi$hssf$record$LeftMarginRecord = clsClass$69;
        }
        clsArr[68] = clsClass$69;
        Class clsClass$70 = class$org$apache$poi$hssf$record$RightMarginRecord;
        if (clsClass$70 == null) {
            clsClass$70 = class$("org.apache.poi.hssf.record.RightMarginRecord");
            class$org$apache$poi$hssf$record$RightMarginRecord = clsClass$70;
        }
        clsArr[69] = clsClass$70;
        Class clsClass$71 = class$org$apache$poi$hssf$record$TopMarginRecord;
        if (clsClass$71 == null) {
            clsClass$71 = class$("org.apache.poi.hssf.record.TopMarginRecord");
            class$org$apache$poi$hssf$record$TopMarginRecord = clsClass$71;
        }
        clsArr[70] = clsClass$71;
        Class clsClass$72 = class$org$apache$poi$hssf$record$BottomMarginRecord;
        if (clsClass$72 == null) {
            clsClass$72 = class$("org.apache.poi.hssf.record.BottomMarginRecord");
            class$org$apache$poi$hssf$record$BottomMarginRecord = clsClass$72;
        }
        clsArr[71] = clsClass$72;
        Class clsClass$73 = class$org$apache$poi$hssf$record$PaletteRecord;
        if (clsClass$73 == null) {
            clsClass$73 = class$("org.apache.poi.hssf.record.PaletteRecord");
            class$org$apache$poi$hssf$record$PaletteRecord = clsClass$73;
        }
        clsArr[72] = clsClass$73;
        Class clsClass$74 = class$org$apache$poi$hssf$record$StringRecord;
        if (clsClass$74 == null) {
            clsClass$74 = class$("org.apache.poi.hssf.record.StringRecord");
            class$org$apache$poi$hssf$record$StringRecord = clsClass$74;
        }
        clsArr[73] = clsClass$74;
        Class clsClass$75 = class$org$apache$poi$hssf$record$SharedFormulaRecord;
        if (clsClass$75 == null) {
            clsClass$75 = class$("org.apache.poi.hssf.record.SharedFormulaRecord");
            class$org$apache$poi$hssf$record$SharedFormulaRecord = clsClass$75;
        }
    ...
    private boolean throwRecordEvent(Record record) {
        ...
        while (it.hasNext()) {
            zProcessRecord = ((ERFListener) it.next()).processRecord(record);
    ...
    public void processRecords(InputStream inputStream) throws RecordFormatException {
        ...
        while (true) {
            try {
                short s = LittleEndian.readShort(inputStream);
                if (s != 0) {
                    ...
                    if (recordArrCreateRecord.length > 1) {
                        while (true) {
                            if (i2 >= recordArrCreateRecord.length) {
                                break;
                            }
                            if (record2 != null && !throwRecordEvent(record2) && this.abortable) {
                                record2 = null;
                                break;
                            } else {
                                record2 = recordArrCreateRecord[i2];
                                i2++;
                            }
                        }
                    } else {
                        ...
                        if (record3 != null) {
                            if (s != 60 || (record2 instanceof ContinueRecord) || (record2 instanceof UnknownRecord)) {
                                if (record2 != null && !throwRecordEvent(record2) && this.abortable) {
                                    break;
                                } else {
                                    record2 = record3;
                                ...
                                record2.processContinueRecord(bArr);
                            }
                        }
                    }
                }
