...
public class DummyGraphics2d extends Graphics2D {
    ...
    public void addRenderingHints(Map map) {
        ...
        System.out.println(new StringBuffer().append("  hints = ").append(map).toString());
        this.g2D.addRenderingHints(map);
    }

    public void clip(Shape shape) {
        System.out.println("clip(Shape):");
        System.out.println(new StringBuffer().append("  s = ").append(shape).toString());
        this.g2D.clip(shape);
    }
    ...
    public void drawGlyphVector(GlyphVector glyphVector, float f, float f2) {
        ...
        System.out.println(new StringBuffer().append("g = ").append(glyphVector).toString());
    ...
    public void drawImage(BufferedImage bufferedImage, BufferedImageOp bufferedImageOp, int i, int i2) {
        ...
        System.out.println(new StringBuffer().append("img = ").append(bufferedImage).toString());
        System.out.println(new StringBuffer().append("op = ").append(bufferedImageOp).toString());
    ...
    public boolean drawImage(Image image, AffineTransform affineTransform, ImageObserver imageObserver) {
        ...
        System.out.println(new StringBuffer().append("img = ").append(image).toString());
        System.out.println(new StringBuffer().append("xform = ").append(affineTransform).toString());
        System.out.println(new StringBuffer().append("obs = ").append(imageObserver).toString());
    ...
    public void drawRenderableImage(RenderableImage renderableImage, AffineTransform affineTransform) {
        ...
        System.out.println(new StringBuffer().append("img = ").append(renderableImage).toString());
        System.out.println(new StringBuffer().append("xform = ").append(affineTransform).toString());
    ...
    public void drawRenderedImage(RenderedImage renderedImage, AffineTransform affineTransform) {
        ...
        System.out.println(new StringBuffer().append("img = ").append(renderedImage).toString());
        System.out.println(new StringBuffer().append("xform = ").append(affineTransform).toString());
    ...
    public void drawString(AttributedCharacterIterator attributedCharacterIterator, float f, float f2) {
        ...
        System.out.println(new StringBuffer().append("iterator = ").append(attributedCharacterIterator).toString());
        System.out.println(new StringBuffer().append("x = ").append(f).toString());
        System.out.println(new StringBuffer().append("y = ").append(f2).toString());
    ...
    public Object getRenderingHint(RenderingHints.Key key) {
        ...
        System.out.println(new StringBuffer().append("hintKey = ").append(key).toString());
    ...
    public boolean hit(Rectangle rectangle, Shape shape, boolean z) {
        ...
        System.out.println(new StringBuffer().append("s = ").append(shape).toString());
        System.out.println(new StringBuffer().append("onStroke = ").append(z).toString());
        return this.g2D.hit(rectangle, shape, z);
    }

    public void rotate(double d) {
        System.out.println("rotate(theta):");
        System.out.println(new StringBuffer().append("theta = ").append(d).toString());
        this.g2D.rotate(d);
    }
    ...
    public void rotate(double d, double d2, double d3) {
        ...
        System.out.println(new StringBuffer().append("theta = ").append(d).toString());
        System.out.println(new StringBuffer().append("x = ").append(d2).toString());
        System.out.println(new StringBuffer().append("y = ").append(d3).toString());
        this.g2D.rotate(d, d2, d3);
    }

    public void scale(double d, double d2) {
        System.out.println("scale(double,double):");
        System.out.println(new StringBuffer().append("sx = ").append(d).toString());
    ...
    public void setBackground(Color color) {
        ...
        System.out.println(new StringBuffer().append("color = ").append(color).toString());
        this.g2D.setBackground(color);
    }

    public void setComposite(Composite composite) {
        System.out.println("setComposite(Composite):");
        System.out.println(new StringBuffer().append("comp = ").append(composite).toString());
        this.g2D.setComposite(composite);
    }

    public void setPaint(Paint paint) {
        System.out.println("setPain(Paint):");
        System.out.println(new StringBuffer().append("paint = ").append(paint).toString());
    ...
    public void setRenderingHint(RenderingHints.Key key, Object obj) {
        ...
        System.out.println(new StringBuffer().append("hintKey = ").append(key).toString());
        System.out.println(new StringBuffer().append("hintValue = ").append(obj).toString());
    ...
    public void setStroke(Stroke stroke) {
        ...
        System.out.println(new StringBuffer().append("s = ").append(stroke).toString());
        this.g2D.setStroke(stroke);
    }

    public void setTransform(AffineTransform affineTransform) {
        System.out.println("setTransform():");
        System.out.println(new StringBuffer().append("Tx = ").append(affineTransform).toString());
        this.g2D.setTransform(affineTransform);
    }

    public void shear(double d, double d2) {
        System.out.println("shear(shx, dhy):");
        System.out.println(new StringBuffer().append("shx = ").append(d).toString());
        System.out.println(new StringBuffer().append("shy = ").append(d2).toString());
        this.g2D.shear(d, d2);
    }
    ...
    public void translate(double d, double d2) {
        ...
        System.out.println(new StringBuffer().append("tx = ").append(d).toString());
        System.out.println(new StringBuffer().append("ty = ").append(d2).toString());
    ...
    public void clearRect(int i, int i2, int i3, int i4) {
        ...
        System.out.println(new StringBuffer().append("x = ").append(i).toString());
        System.out.println(new StringBuffer().append("y = ").append(i2).toString());
        System.out.println(new StringBuffer().append("width = ").append(i3).toString());
        System.out.println(new StringBuffer().append("height = ").append(i4).toString());
    ...
    public void draw3DRect(int i, int i2, int i3, int i4, boolean z) {
        ...
        System.out.println(new StringBuffer().append("width = ").append(i3).toString());
        System.out.println(new StringBuffer().append("height = ").append(i4).toString());
        System.out.println(new StringBuffer().append("raised = ").append(z).toString());
    ...
    public void drawArc(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        System.out.println(new StringBuffer().append("width = ").append(i3).toString());
        System.out.println(new StringBuffer().append("height = ").append(i4).toString());
        System.out.println(new StringBuffer().append("startAngle = ").append(i5).toString());
        System.out.println(new StringBuffer().append("arcAngle = ").append(i6).toString());
        this.g2D.drawArc(i, i2, i3, i4, i5, i6);
    }

    public void drawBytes(byte[] bArr, int i, int i2, int i3, int i4) {
        System.out.println("drawBytes(byte[],int,int,int,int):");
        System.out.println(new StringBuffer().append("data = ").append(bArr).toString());
        ...
        System.out.println(new StringBuffer().append("x = ").append(i3).toString());
        System.out.println(new StringBuffer().append("y = ").append(i4).toString());
        this.g2D.drawBytes(bArr, i, i2, i3, i4);
    }

    public void drawChars(char[] cArr, int i, int i2, int i3, int i4) {
        System.out.println("drawChars(data,int,int,int,int):");
        System.out.println(new StringBuffer().append("data = ").append((Object) cArr).toString());
        System.out.println(new StringBuffer().append("offset = ").append(i).toString());
        System.out.println(new StringBuffer().append("length = ").append(i2).toString());
        System.out.println(new StringBuffer().append("x = ").append(i3).toString());
        System.out.println(new StringBuffer().append("y = ").append(i4).toString());
    ...
    public boolean drawImage(Image image, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, ImageObserver imageObserver) {
        ...
        System.out.println(new StringBuffer().append("img = ").append(image).toString());
        System.out.println(new StringBuffer().append("dx1 = ").append(i).toString());
        System.out.println(new StringBuffer().append("dy1 = ").append(i2).toString());
        System.out.println(new StringBuffer().append("dx2 = ").append(i3).toString());
        System.out.println(new StringBuffer().append("dy2 = ").append(i4).toString());
        System.out.println(new StringBuffer().append("sx1 = ").append(i5).toString());
        System.out.println(new StringBuffer().append("sy1 = ").append(i6).toString());
        System.out.println(new StringBuffer().append("sx2 = ").append(i7).toString());
        System.out.println(new StringBuffer().append("sy2 = ").append(i8).toString());
        System.out.println(new StringBuffer().append("observer = ").append(imageObserver).toString());
    ...
    public boolean drawImage(Image image, int i, int i2, int i3, int i4, int i5, int i6, int i7, int i8, Color color, ImageObserver imageObserver) {
        ...
        System.out.println(new StringBuffer().append("sx2 = ").append(i7).toString());
        System.out.println(new StringBuffer().append("sy2 = ").append(i8).toString());
        System.out.println(new StringBuffer().append("bgcolor = ").append(color).toString());
        System.out.println(new StringBuffer().append("observer = ").append(imageObserver).toString());
    ...
    public void drawLine(int i, int i2, int i3, int i4) {
        ...
        System.out.println(new StringBuffer().append("y1 = ").append(i2).toString());
        System.out.println(new StringBuffer().append("x2 = ").append(i3).toString());
        System.out.println(new StringBuffer().append("y2 = ").append(i4).toString());
    ...
    public void drawPolygon(Polygon polygon) {
        ...
        System.out.println(new StringBuffer().append("p = ").append(polygon).toString());
        this.g2D.drawPolygon(polygon);
    }

    public void drawPolygon(int[] iArr, int[] iArr2, int i) {
        System.out.println("drawPolygon(int[],int[],int):");
        System.out.println(new StringBuffer().append("xPoints = ").append(iArr).toString());
        System.out.println(new StringBuffer().append("yPoints = ").append(iArr2).toString());
        System.out.println(new StringBuffer().append("nPoints = ").append(i).toString());
    ...
    public void drawRoundRect(int i, int i2, int i3, int i4, int i5, int i6) {
        ...
        System.out.println(new StringBuffer().append("width = ").append(i3).toString());
        System.out.println(new StringBuffer().append("height = ").append(i4).toString());
        System.out.println(new StringBuffer().append("arcWidth = ").append(i5).toString());
        System.out.println(new StringBuffer().append("arcHeight = ").append(i6).toString());
    ...
    public Rectangle getClipBounds(Rectangle rectangle) {
        ...
        System.out.println(new StringBuffer().append("r = ").append(rectangle).toString());
    ...
    public void setClip(Shape shape) {
        ...
        System.out.println(new StringBuffer().append("clip = ").append(shape).toString());
    ...
    public void setColor(Color color) {
        ...
        System.out.println(new StringBuffer().append("c = ").append(color).toString());
        this.g2D.setColor(color);
    }

    public void setFont(Font font) {
        System.out.println("setFont(Font):");
        System.out.println(new StringBuffer().append("font = ").append(font).toString());
    ...
    public void setXORMode(Color color) {
        ...
        System.out.println(new StringBuffer().append("c1 = ").append(color).toString());
