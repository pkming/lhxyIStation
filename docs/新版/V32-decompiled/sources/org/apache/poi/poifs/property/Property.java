...
public abstract class Property implements Child, POIFSViewable {
    ...
    public Object[] getViewableArray() {
        return new Object[]{new StringBuffer().append("Name          = \"").append(getName()).append("\"").toString(), new StringBuffer().append("Property Type = ").append((int) this._property_type.get()).toString(), new StringBuffer().append("Node Color    = ").append((int) this._node_color.get()).toString(), new StringBuffer().append("Time 1        = ").append((((long) this._days_1.get()) << 32) + (((long) this._seconds_1.get()) & 65535)).toString(), new StringBuffer().append("Time 2        = ").append((((long) this._days_2.get()) << 32) + (((long) this._seconds_2.get()) & 65535)).toString()};
    }
