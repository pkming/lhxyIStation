...
public final class Buffer implements BufferedSource, BufferedSink, Cloneable {
    private static final byte[] DIGITS = {TarConstants.LF_NORMAL, TarConstants.LF_LINK, TarConstants.LF_SYMLINK, TarConstants.LF_CHR, TarConstants.LF_BLK, TarConstants.LF_DIR, TarConstants.LF_FIFO, TarConstants.LF_CONTIG, PaletteRecord.STANDARD_PALETTE_SIZE, 57, 97, 98, 99, 100, 101, 102};
    ...
    public Buffer readFrom(InputStream inputStream) throws IOException {
        readFrom(inputStream, LinkQualityInfo.UNKNOWN_LONG, true);
        return this;
    }
    ...
    public long readLong() {
        ...
        int i2 = segment.limit;
        if (i2 - i < 8) {
            return ((((long) readInt()) & ExpandableListView.PACKED_POSITION_VALUE_NULL) << 32) | (ExpandableListView.PACKED_POSITION_VALUE_NULL & ((long) readInt()));
        }
        byte[] bArr = segment.data;
        int i3 = i + 1;
    ...
    */
    ...
    public int readUtf8CodePoint() throws EOFException {
        ...
        if ((b & 128) == 0) {
            ...
            i = b & HSSFErrorConstants.ERROR_VALUE;
            i2 = 3;
            i3 = 2048;
        } else {
            if ((b & 248) != 240) {
    ...
    public long writeAll(Source source) throws IOException {
        ...
        long j = 0;
        while (true) {
            long j2 = source.read(this, Trace.TRACE_TAG_RESOURCES);
            if (j2 == -1) {
                return j;
            }
            j += j2;
        ...
        while (j > 0) {
            if (j < buffer.head.limit - buffer.head.pos) {
                ...
                if (segment2 != null && segment2.owner) {
                    if ((((long) segment2.limit) + j) - ((long) (segment2.shared ? 0 : segment2.pos)) <= Trace.TRACE_TAG_RESOURCES) {
