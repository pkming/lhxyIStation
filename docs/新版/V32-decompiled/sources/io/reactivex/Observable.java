...
public abstract class Observable<T> implements ObservableSource<T> {
    ...
    public final <U extends Collection<? super T>> Observable<U> buffer(int i, int i2, Callable<U> callable) {
        ObjectHelper.verifyPositive(i, HardwareRenderer.OVERDRAW_PROPERTY_COUNT);
        ObjectHelper.verifyPositive(i2, MSVSSConstants.WRITABLE_SKIP);
    ...
    public final Observable<T> repeat() {
        return repeat(LinkQualityInfo.UNKNOWN_LONG);
    }
    ...
    public final Observable<T> retry() {
        return retry(LinkQualityInfo.UNKNOWN_LONG, Functions.alwaysTrue());
    }
    ...
    public final Observable<T> retry(Predicate<? super Throwable> predicate) {
        return retry(LinkQualityInfo.UNKNOWN_LONG, predicate);
    }
    ...
    public final Observable<T> retryUntil(BooleanSupplier booleanSupplier) {
        ObjectHelper.requireNonNull(booleanSupplier, "stop is null");
        return retry(LinkQualityInfo.UNKNOWN_LONG, Functions.predicateReverseFor(booleanSupplier));
    }
    ...
    public final Observable<T> takeLast(long j, TimeUnit timeUnit, Scheduler scheduler, boolean z, int i) {
        return takeLast(LinkQualityInfo.UNKNOWN_LONG, j, timeUnit, scheduler, z, i);
    }
    ...
    public final Observable<Observable<T>> window(long j, long j2, int i) {
        ObjectHelper.verifyPositive(j, HardwareRenderer.OVERDRAW_PROPERTY_COUNT);
        ObjectHelper.verifyPositive(j2, MSVSSConstants.WRITABLE_SKIP);
        ObjectHelper.verifyPositive(i, "bufferSize");
    ...
    public final Observable<Observable<T>> window(long j, long j2, TimeUnit timeUnit, Scheduler scheduler, int i) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        return RxJavaPlugins.onAssembly(new ObservableWindowTimed(this, j, j2, timeUnit, scheduler, LinkQualityInfo.UNKNOWN_LONG, i, false));
    }

    @SchedulerSupport(SchedulerSupport.COMPUTATION)
    @CheckReturnValue
    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit) {
        return window(j, timeUnit, Schedulers.computation(), LinkQualityInfo.UNKNOWN_LONG, false);
    }
    ...
    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit, Scheduler scheduler) {
        return window(j, timeUnit, scheduler, LinkQualityInfo.UNKNOWN_LONG, false);
    }
    ...
    public final Observable<Observable<T>> window(long j, TimeUnit timeUnit, Scheduler scheduler, long j2, boolean z, int i) {
        ...
        ObjectHelper.requireNonNull(scheduler, "scheduler is null");
        ObjectHelper.requireNonNull(timeUnit, "unit is null");
        ObjectHelper.verifyPositive(j2, HardwareRenderer.OVERDRAW_PROPERTY_COUNT);
