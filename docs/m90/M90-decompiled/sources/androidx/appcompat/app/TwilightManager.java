...
class TwilightManager {
    ...
    private Location getLastKnownLocation() {
        ...
        Location lastKnownLocationForProvider2 = PermissionChecker.checkSelfPermission(this.mContext, Manifest.permission.ACCESS_FINE_LOCATION) == 0 ? getLastKnownLocationForProvider("gps") : null;
    ...
    private void updateState(Location location) {
        ...
        if (j3 == -1 || j4 == -1) {
            j = AlarmManager.INTERVAL_HALF_DAY + jCurrentTimeMillis;
        } else {
