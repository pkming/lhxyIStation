...
public final class Util {
    ...
    private static final Charset UTF_16_BE = Charset.forName(MediaPlayer.CHARSET_UTF_16BE);
    private static final Charset UTF_16_LE = Charset.forName(MediaPlayer.CHARSET_UTF_16LE);
    private static final Charset UTF_32_BE = Charset.forName(MediaPlayer.CHARSET_UTF_32BE);
    private static final Charset UTF_32_LE = Charset.forName(MediaPlayer.CHARSET_UTF_32LE);
    ...
    public static boolean skipAll(Source source, int i, TimeUnit timeUnit) throws IOException {
        ...
        try {
            ...
            while (source.read(buffer, Trace.TRACE_TAG_RESOURCES) != -1) {
                buffer.clear();
            }
            if (jDeadlineNanoTime == LinkQualityInfo.UNKNOWN_LONG) {
