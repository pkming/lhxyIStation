...
public final class jp {
    ...
    private static int[] b() {
        ...
        while (true) {
            ...
            byte[] bArrB = il.b(strArr[i]);
            iArr2[i] = ((bArrB[0] & 255) << 24) | (bArrB[3] & 255) | ((bArrB[2] & 255) << 8) | ((bArrB[1] & 255) << 16);
            i++;
        }
    }
    ...
    public static String a() {
        ...
        try {
            ...
            return jk.a(keyGenerator.generateKey().getEncoded());
    ...
    public static String b(String str) {
        try {
            return jk.a(a(str.getBytes("UTF-8")));
        } catch (Throwable unused) {
            return null;
        }
    }
    ...
    private static byte[] a(byte[] bArr) {
        try {
            if (a == null) {
                a = it.c("YAAAAAAAAAAAAAAAAAAAAAA").getBytes();
            }
            IvParameterSpec ivParameterSpec = new IvParameterSpec(a);
            SecretKeySpec secretKeySpec = new SecretKeySpec(a(b()).getBytes("UTF-8"), it.c("EQUVT"));
