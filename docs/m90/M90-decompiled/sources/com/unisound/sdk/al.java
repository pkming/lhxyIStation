...
public class al {
    public static com.unisound.common.a a = new com.unisound.common.a("asrv3.hivoice.cn", 80, "117.121.49.41", 80);
    ...
    public static com.unisound.common.a a(String str) {
        return str.equals("en") ? b : str.equals("co") ? c : str.equals(an.au) ? d : an.av.equals(str) ? f : a;
    }
}
