...
public class ErrorCode {
    ...
    public static final int ASR_SDK_SET_RECOGNIZE_MODEL_ID_ERROR = -63533;
    public static final int ASR_SDK_SET_WAKEUP_MODEL_ID_ERROR = -63541;
    public static final int ASR_SDK_START_ERROR = -63532;
    public static final int ASR_SDK_UPLOAD_ONESHOT_ONLINE_ENCODE_ERROR = -63605;
    public static final int ASR_SDK_UPLOAD_ONESHOT_ONLINE_EXCEED_MAXLIMIT = -63602;
    public static final int ASR_SDK_UPLOAD_ONESHOT_ONLINE_ILLEGAL = -63601;
    public static final int ASR_SDK_UPLOAD_ONESHOT_ONLINE_NETWORK_ERROR = -63603;
    public static final int ASR_SDK_UPLOAD_ONESHOT_ONLINE_SERVER_REFUSED = -63604;
    public static final int ASR_SDK_WAKEUP_ERROR = -63540;
    ...
    public static final int HTTP_ERROR_APPKEY = -91725;
    ...
    public static final int TTS_ERROR_AUDIOSOURCE_OPEN = -91101;
    public static final int TTS_ERROR_GET_ENGINE_INFO = -91106;
    public static final int TTS_ERROR_GET_MODEL = -90001;
    public static final int TTS_ERROR_LOAD_MODEL = -90002;
    public static final int TTS_ERROR_OFFLINE_CHANGE_SPEAKER_FAIL = -91105;
    public static final int TTS_ERROR_OFFLINE_CHANGE_SPEAKER_IS_PROCESSING = -91107;
    public static final int TTS_ERROR_OFFLINE_ENGINE_IS_PROCESSING = -91104;
    public static final int TTS_ERROR_OFFLINE_ENGINE_NOT_INIT = -91103;
    public static final int TTS_ERROR_OFFLINE_SYNTHESIZER_SET_TEXT = -90004;
    public static final int TTS_ERROR_ONLINE_SYNTHESIZER_INIT = -91100;
    public static final int TTS_ERROR_PLAYING_EXCEPTION = -91102;
    public static final int TTS_ERROR_TEXT_UNUSEABLE = -90003;
    ...
    public static bw createOralError(int i) {
        switch (i) {
            case RECOGNITION_EXCEPTION /* -62001 */:
                return new bw(i, "识别异常");
            case RECORDING_EXCEPTION /* -61002 */:
                return new bw(i, "录音异常");
            case FAILED_START_RECORDING /* -61001 */:
                return new bw(i, "启动录音失败");
            case ASRCLIENT_COMPRESS_PCM_ERROR /* -30003 */:
                return new bw(i, "数据压缩错误");
            case ASRCLIENT_MAX_SPEECH_TIMEOUT /* -30002 */:
                return new bw(i, "说话时间超出限制");
            default:
                return new bw(-10001, "服务器连接错误");
        }
    }

    public static String toJsonMessage(int i) {
        JSONObject jSONObject = new JSONObject();
        try {
            jSONObject.put("errorCode", i);
            jSONObject.put(Downloads.Impl.COLUMN_ERROR_MSG, toMessage(i));
        } catch (JSONException e) {
            e.printStackTrace();
            r.c("ErrorCode", "errorCode Not Define.");
        }
            ...
            default:
                switch (i) {
                    ...
                    case INIT_ERROR /* -91000 */:
                        return "初始化错误";
                    case TTS_ERROR_OFFLINE_SYNTHESIZER_SET_TEXT /* -90004 */:
                        return "离线合成设置文成出错";
                    case TTS_ERROR_TEXT_UNUSEABLE /* -90003 */:
                        return "合成文本不可用";
                    case TTS_ERROR_LOAD_MODEL /* -90002 */:
                        return "模型加载失败！";
                    case TTS_ERROR_GET_MODEL /* -90001 */:
                        return "模型生成失败！";
                    ...
                    case ASR_SDK_SET_ASR_SERVER_ADDR_ERROR /* -63542 */:
                        return "语言识别服务地址设置失败";
                    case ASR_SDK_SET_WAKEUP_MODEL_ID_ERROR /* -63541 */:
                        return "离线唤醒模型ID设置失败";
                    case ASR_SDK_WAKEUP_ERROR /* -63540 */:
                        return "语音唤醒加载错误";
                    case ASR_SDK_SET_RECOGNIZE_MODEL_ID_ERROR /* -63533 */:
                        return "离线识别模型ID设置失败";
                                                                ...
                                                                switch (i) {
                                                                    ...
                                                                    default:
                                                                        switch (i) {
                                                                            ...
                                                                            default:
                                                                                switch (i) {
                                                                                    case TTS_ERROR_OFFLINE_CHANGE_SPEAKER_IS_PROCESSING /* -91107 */:
                                                                                        return "离线tts正在执行切换发音人，请稍后再试";
                                                                                    case TTS_ERROR_GET_ENGINE_INFO /* -91106 */:
                                                                                        return "离线tts获取引擎信息错误，请先执行init并设置本地模式！";
                                                                                    case TTS_ERROR_OFFLINE_CHANGE_SPEAKER_FAIL /* -91105 */:
                                                                                        return "离线tts切换发音人模型错误";
                                                                                    case TTS_ERROR_OFFLINE_ENGINE_IS_PROCESSING /* -91104 */:
                                                                                        return "离线tts引擎正在执行合成，请稍等再试";
                                                                                    case TTS_ERROR_OFFLINE_ENGINE_NOT_INIT /* -91103 */:
                                                                                        return "离线tts引擎未初始化，请确认执行init并接收init回调！";
                                                                                    case TTS_ERROR_PLAYING_EXCEPTION /* -91102 */:
                                                                                        return "播放异常错误";
                                                                                    case TTS_ERROR_AUDIOSOURCE_OPEN /* -91101 */:
                                                                                        return "播放线程打开audioSource出错";
                                                                                    case TTS_ERROR_ONLINE_SYNTHESIZER_INIT /* -91100 */:
                                                                                        return "在线合成初始化错误";
                                                                                    default:
                                                                                        return "其他异常";
                                                                                }
    ...
    public bw createBasicError(int i) {
        if (i == 0) {
            return null;
        }
        int profession = toProfession(i);
        return new bw(profession, getMessage(profession));
    }

    public bw createPremiumError(int i) {
        if (i == 0) {
            return null;
        }
        return new bw(i, getMessage(toProfession(i)));
    }

    public bw createProfessionError(int i) {
        if (i == 0) {
            return null;
        }
        return new bw(i, getMessage(toProfession(i)));
