...
public final class af {
    ...
    /* JADX WARN: Removed duplicated region for block: B:88:0x0168 A[PHI: r4 r6 r7 r10 r13 r14 r18
      ...
      0x0168: PHI (r10v8 java.lang.String) = (r10v7 java.lang.String), (r10v12 java.lang.String) binds: [B:103:0x0188, B:87:0x0166] A[DONT_GENERATE, DONT_INLINE]
      0x0168: PHI (r13v5 int) = (r13v4 int), (r13v7 int) binds: [B:103:0x0188, B:87:0x0166] A[DONT_GENERATE, DONT_INLINE]
    ...
    private static HttpURLConnection a(String str, String str2) {
        ...
        try {
            ...
            if (an.a != null) {
                ...
                httpURLConnection = (HttpURLConnection) url.openConnection(new Proxy(Proxy.Type.HTTP, new InetSocketAddress(System.getProperty(ProxySetup.HTTP_PROXY_HOST), Integer.parseInt(System.getProperty(ProxySetup.HTTP_PROXY_PORT)))));
            } else {
