...
public class WheelDatePicker extends LinearLayout implements WheelPicker.OnItemSelectedListener, IDebug, IWheelPicker, IWheelDatePicker, IWheelYearPicker, IWheelMonthPicker, IWheelDayPicker {
    ...
    public WheelDatePicker(Context context, AttributeSet attributeSet) {
        ...
        this.mPickerMonth.setMaximumWidthText(TarConstants.VERSION_POSIX);
        this.mPickerDay.setMaximumWidthText(TarConstants.VERSION_POSIX);
    ...
    private void setMaximumWidthTextYear() {
        String strValueOf = String.valueOf(this.mPickerYear.getData().get(r0.size() - 1));
    ...
    public void onItemSelected(WheelPicker wheelPicker, Object obj, int i) {
        if (wheelPicker.getId() == R.id.wheel_date_picker_year) {
            ...
            this.mYear = iIntValue;
            this.mPickerDay.setYear(iIntValue);
        } else if (wheelPicker.getId() == R.id.wheel_date_picker_month) {
            int iIntValue2 = ((Integer) obj).intValue();
            this.mMonth = iIntValue2;
            this.mPickerDay.setMonth(iIntValue2);
        }
        this.mDay = this.mPickerDay.getCurrentDay();
