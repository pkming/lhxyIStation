...
public class CBZip2OutputStream extends OutputStream implements BZip2Constants {
    ...
    private void sendMTFValues() throws IOException {
        ...
        while (true) {
            ...
            while (true) {
                i3--;
                if (i3 >= 0) {
                    bArr2[i3] = HSSFErrorConstants.ERROR_VALUE;
                }
            }
        }
        int i4 = this.nMTF;
            ...
            while (true) {
                ...
                if (i10 >= 0) {
                    if (i10 >= i4 && i10 <= i7) {
                        ...
                        bArr2[i10] = HSSFErrorConstants.ERROR_VALUE;
                    }
                }
            }
            i4 = i7 + 1;
    ...
    private int sendMTFValues1(int i, int i2) {
        ...
        byte[] bArr8 = bArr3[4];
        byte[] bArr9 = bArr3[5];
        int i6 = cBZip2OutputStream.nMTF;
        int i7 = 0;
        int i8 = 0;
        while (i7 < i5) {
            int i9 = i;
            ...
            int i11 = i4;
            i8 = i11;
            while (i11 < cBZip2OutputStream.nMTF) {
                int i12 = i11;
                int iMin = Math.min((i11 + 50) - 1, i6 - 1);
                if (i == 6) {
                    int i13 = i12;
                    short s = 0;
                    short s2 = 0;
            ...
            int i22 = 0;
            while (i22 < i) {
                hbMakeCodeLengths(bArr3[i22], iArr[i22], cBZip2OutputStream.data, i2, 20);
                i22++;
