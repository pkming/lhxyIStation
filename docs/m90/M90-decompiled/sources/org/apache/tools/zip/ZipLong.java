...
public final class ZipLong implements Cloneable {
    ...
    static final ZipLong ZIP64_MAGIC = new ZipLong(ExpandableListView.PACKED_POSITION_VALUE_NULL);
    ...
    public static long getValue(byte[] bArr, int i) {
        return (((long) (bArr[i + 3] << 24)) & BYTE_3_MASK) + ((long) ((bArr[i + 2] << 16) & 16711680)) + ((long) ((bArr[i + 1] << 8) & 65280)) + ((long) (bArr[i] & 255));
    }
