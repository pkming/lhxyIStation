...
public class EscherClientDataRecord extends EscherRecord {
    ...
    public String toString() {
        ...
        return new StringBuffer().append(getClass().getName()).append(":").append(property).append("  RecordId: 0x").append(HexDump.toHex(RECORD_ID)).append(property).append("  Options: 0x").append(HexDump.toHex(getOptions())).append(property).append("  Extra Data:").append(property).append(string).toString();
    }
