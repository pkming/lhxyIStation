...
public class NumberRecord extends Record implements CellValueRecordInterface, Comparable {
    ...
    public NumberRecord(short s, short s2, byte[] bArr) {
        super(s, s2, bArr);
    }

    public NumberRecord(short s, short s2, byte[] bArr, int i) {
        super(s, s2, bArr, i);
    }
    ...
    protected void fillFields(byte[] bArr, short s, int i) {
        ...
        this.field_4_value = LittleEndian.getDouble(bArr, i + 6);
    }
    ...
    public int serialize(int i, byte[] bArr) {
        LittleEndian.putShort(bArr, i + 0, (short) 515);
        ...
        LittleEndian.putDouble(bArr, i + 10, getValue());
