...
public class WSBoolRecord extends Record {
    ...
    private static final BitField autobreaks = new BitField(1);
    private static final BitField dialog = new BitField(16);
    private static final BitField applystyles = new BitField(32);
    private static final BitField rowsumsbelow = new BitField(64);
    private static final BitField rowsumsright = new BitField(128);
    private static final BitField fittopage = new BitField(1);
    private static final BitField displayguts = new BitField(6);
    private static final BitField alternateexpression = new BitField(64);
    private static final BitField alternateformula = new BitField(128);
    ...
    protected void fillFields(byte[] bArr, short s, int i) {
        this.field_1_wsbool = bArr[i + 1];
        this.field_2_wsbool = bArr[i + 0];
    }
    ...
    public int serialize(int i, byte[] bArr) {
        LittleEndian.putShort(bArr, i + 0, (short) 129);
