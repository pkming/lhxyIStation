...
public class EscherGraphics2d extends Graphics2D {
    ...
    public Graphics create() {
        return new EscherGraphics2d(this.escherGraphics);
    }
    ...
    public void draw(Shape shape) {
        if (this.logger.check(5)) {
            this.logger.log(5, "copyArea not supported");
        }
    }
    ...
    public void drawLine(int i, int i2, int i3, int i4) {
        getEscherGraphics().drawLine(i, i2, i3, i4);
    }
    ...
    public Color getColor() {
        return this.escherGraphics.getColor();
    }
    ...
    public void setColor(Color color) {
        this.escherGraphics.setColor(color);
    }
