...
public class ExtendedFormatRecord extends Record {
    ...
    private static final BitField _locked = new BitField(1);
    private static final BitField _hidden = new BitField(2);
    private static final BitField _xf_type = new BitField(4);
    private static final BitField _123_prefix = new BitField(8);
    private static final BitField _parent_index = new BitField(65520);
    private static final BitField _alignment = new BitField(7);
    private static final BitField _wrap_text = new BitField(8);
    private static final BitField _vertical_alignment = new BitField(112);
    private static final BitField _justify_last = new BitField(128);
    private static final BitField _rotation = new BitField(65280);
    private static final BitField _indent = new BitField(15);
    private static final BitField _shrink_to_fit = new BitField(16);
    private static final BitField _merge_cells = new BitField(32);
    private static final BitField _reading_order = new BitField(192);
    private static final BitField _indent_not_parent_format = new BitField(1024);
    private static final BitField _indent_not_parent_font = new BitField(2048);
    private static final BitField _indent_not_parent_alignment = new BitField(4096);
    private static final BitField _indent_not_parent_border = new BitField(8192);
    private static final BitField _indent_not_parent_pattern = new BitField(16384);
    private static final BitField _indent_not_parent_cell_options = new BitField(32768);
    private static final BitField _border_left = new BitField(15);
    private static final BitField _border_right = new BitField(240);
    private static final BitField _border_top = new BitField(BatteryStats.HistoryItem.STATE_PHONE_STATE_MASK);
    private static final BitField _border_bottom = new BitField(BatteryStats.HistoryItem.STATE_DATA_CONNECTION_MASK);
    private static final BitField _left_border_palette_idx = new BitField(127);
    private static final BitField _right_border_palette_idx = new BitField(16256);
    private static final BitField _diag = new BitField(49152);
    private static final BitField _top_border_palette_idx = new BitField(127);
    private static final BitField _bottom_border_palette_idx = new BitField(16256);
    private static final BitField _adtl_diag = new BitField(2080768);
    private static final BitField _adtl_diag_line_style = new BitField(31457280);
    private static final BitField _adtl_fill_pattern = new BitField(-67108864);
    private static final BitField _fill_foreground = new BitField(127);
    private static final BitField _fill_background = new BitField(16256);
    ...
    protected void fillFields(byte[] bArr, short s, int i) {
        this.field_1_font_index = LittleEndian.getShort(bArr, i + 0);
        this.field_2_format_index = LittleEndian.getShort(bArr, i + 2);
        this.field_3_cell_options = LittleEndian.getShort(bArr, i + 4);
        this.field_4_alignment_options = LittleEndian.getShort(bArr, i + 6);
        this.field_5_indention_options = LittleEndian.getShort(bArr, i + 8);
        this.field_6_border_options = LittleEndian.getShort(bArr, i + 10);
        this.field_7_palette_options = LittleEndian.getShort(bArr, i + 12);
        this.field_8_adtl_palette_options = LittleEndian.getInt(bArr, i + 14);
        this.field_9_fill_palette_options = LittleEndian.getShort(bArr, i + 18);
    }
    ...
    public int serialize(int i, byte[] bArr) {
        LittleEndian.putShort(bArr, i + 0, (short) 224);
        LittleEndian.putShort(bArr, i + 2, (short) 20);
        LittleEndian.putShort(bArr, i + 4, getFontIndex());
        LittleEndian.putShort(bArr, i + 6, getFormatIndex());
        LittleEndian.putShort(bArr, i + 8, getCellOptions());
        LittleEndian.putShort(bArr, i + 10, getAlignmentOptions());
        LittleEndian.putShort(bArr, i + 12, getIndentionOptions());
        LittleEndian.putShort(bArr, i + 14, getBorderOptions());
        LittleEndian.putShort(bArr, i + 16, getPaletteOptions());
        LittleEndian.putInt(bArr, i + 18, getAdtlPaletteOptions());
        LittleEndian.putShort(bArr, i + 22, getFillPaletteOptions());
