...
public class ExtendedPOP3Client extends POP3SClient {
    public boolean auth(AUTH_METHOD auth_method, String str, String str2) throws InvalidKeySpecException, NoSuchAlgorithmException, InvalidKeyException, IOException {
        ...
        if (i == 1) {
            return sendCommand(new String(Base64.encodeBase64(new StringBuilder().append("\u0000").append(str).append("\u0000").append(str2).toString().getBytes(getCharsetName())), getCharsetName())) == 0;
        }
        if (i != 2) {
            return false;
        }
    ...
    /* JADX INFO: renamed from: org.apache.commons.net.pop3.ExtendedPOP3Client$1, reason: invalid class name */
