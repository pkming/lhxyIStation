...
public class QueryBuilder<T> {
    ...
    protected StringBuilder append(StringBuilder sb, Property property) {
        ...
        sb.append(this.tablePrefix).append('.').append(DateFormat.QUOTE).append(property.columnName).append(DateFormat.QUOTE);
        return sb;
    }
    ...
    private void appendJoinsAndWheres(StringBuilder sb, String str) {
        ...
        for (Join<T, ?> join : this.joins) {
            sb.append(" JOIN ");
            sb.append('\"').append(join.daoDestination.getTablename()).append('\"').append(' ');
