...
public interface IVibratorService extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IVibratorService {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
                vibrate(parcel.readInt(), parcel.readString(), parcel.readLong(), parcel.readStrongBinder());
                parcel2.writeNoException();
                return true;
            }
            if (i == 3) {
                parcel.enforceInterface(DESCRIPTOR);
                vibratePattern(parcel.readInt(), parcel.readString(), parcel.createLongArray(), parcel.readInt(), parcel.readStrongBinder());
                parcel2.writeNoException();
                return true;
            }
            if (i != 4) {
        ...
        private static class Proxy implements IVibratorService {
            ...
            @Override // android.os.IVibratorService
            public void vibrate(int i, String str, long j, IBinder iBinder) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.os.IVibratorService
            public void vibratePattern(int i, String str, long[] jArr, int i2, IBinder iBinder) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
