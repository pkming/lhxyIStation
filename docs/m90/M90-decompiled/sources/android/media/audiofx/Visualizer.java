...
public class Visualizer {
    ...
    public Visualizer(int i) throws RuntimeException {
        ...
        synchronized (obj) {
            this.mState = 0;
            int iNative_setup = native_setup(new WeakReference(this), i, iArr);
    ...
    public int setEnabled(boolean z) throws IllegalStateException {
        ...
        synchronized (this.mStateLock) {
            ...
            int i2 = 2;
            if (((z && i == 1) || (!z && i == 2)) && (iNative_setEnabled = native_setEnabled(z)) == 0) {
                if (!z) {
                    i2 = 1;
                }
                this.mState = i2;
    ...
    private static void postEventFromNative(Object obj, int i, int i2, int i3, Object obj2) {
        ...
        if (visualizer == null || (nativeEventHandler = visualizer.mNativeEventHandler) == null) {
            return;
        }
        visualizer.mNativeEventHandler.sendMessage(nativeEventHandler.obtainMessage(i, i2, i3, obj2));
    }
}
