...
public final class URLUtil {
    ...
    public static boolean isFileUrl(String str) {
        return (str == null || !str.startsWith("file://") || str.startsWith(ASSET_BASE) || str.startsWith(PROXY_BASE)) ? false : true;
    }
        ...
        if (iIndexOf2 < 0) {
            ...
            if (strSubstring2 == null) {
                if (str3 == null || !str3.toLowerCase(Locale.ROOT).startsWith("text/")) {
                    ...
                    strSubstring2 = str3.equalsIgnoreCase(ClipDescription.MIMETYPE_TEXT_HTML) ? ".html" : ".txt";
                }
            }
        } else {
            if (str3 != null) {
