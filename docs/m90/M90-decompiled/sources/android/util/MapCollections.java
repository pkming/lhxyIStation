...
abstract class MapCollections<K, V> {
    ...
    final class MapIterator implements Iterator<Map.Entry<K, V>>, Map.Entry<K, V> {
        ...
        public final boolean equals(Object obj) {
            ...
            return Objects.equal(entry.getKey(), MapCollections.this.colGetEntry(this.mIndex, 0)) && Objects.equal(entry.getValue(), MapCollections.this.colGetEntry(this.mIndex, 1));
        }
    ...
    final class EntrySet implements Set<Map.Entry<K, V>> {
        ...
        public boolean contains(Object obj) {
            ...
            return Objects.equal(MapCollections.this.colGetEntry(iColIndexOfKey, 1), entry.getValue());
        }
