...
public final class ScriptIntrinsicHistogram extends ScriptIntrinsic {
    ...
    private ScriptIntrinsicHistogram(int i, RenderScript renderScript) {
    ...
    public void forEach(Allocation allocation) {
        ...
        if (allocation.getType().getElement().isCompatible(Element.U8(this.mRS)) && allocation.getType().getElement().isCompatible(Element.U8_4(this.mRS))) {
    ...
    public void forEach_Dot(Allocation allocation) {
        ...
        forEach(1, allocation, null, null);
    }
