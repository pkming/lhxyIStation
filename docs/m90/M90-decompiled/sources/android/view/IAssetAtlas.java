...
public interface IAssetAtlas extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAssetAtlas {
        ...
        public static IAssetAtlas asInterface(IBinder iBinder) {
            ...
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IAssetAtlas)) {
                return (IAssetAtlas) iInterfaceQueryLocalInterface;
            }
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                boolean zIsCompatible = isCompatible(parcel.readInt());
                parcel2.writeNoException();
                parcel2.writeInt(zIsCompatible ? 1 : 0);
                return true;
            }
            if (i == 2) {
                parcel.enforceInterface(DESCRIPTOR);
        ...
        private static class Proxy implements IAssetAtlas {
            ...
            public GraphicBuffer getBuffer() throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    return parcelObtain2.readInt() != 0 ? GraphicBuffer.CREATOR.createFromParcel(parcelObtain2) : null;
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
