...
public class ScrollView extends FrameLayout {
    ...
    */
    public boolean onInterceptTouchEvent(android.view.MotionEvent r11) {
        ...
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.ScrollView.onInterceptTouchEvent(android.view.MotionEvent):boolean");
    }
                ...
                if (action == 2) {
                    ...
                    if (iFindPointerIndex == -1) {
                        ...
                        if (this.mIsBeingDragged) {
                            ...
                            if (overScrollBy(0, i, 0, this.mScrollY, 0, scrollRange, 0, this.mOverscrollDistance, true)) {
    ...
    */
    private android.view.View findFocusableViewInBounds(boolean r13, int r14, int r15) {
        ...
        L53:
            return r3
        */
        throw new UnsupportedOperationException("Method not decompiled: android.widget.ScrollView.findFocusableViewInBounds(boolean, int, int):android.view.View");
    }
