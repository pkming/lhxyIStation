...
public abstract class SimpleCursorTreeAdapter extends ResourceCursorTreeAdapter {
    ...
    private void bindView(View view, Context context, Cursor cursor, int[] iArr, int[] iArr2) throws Throwable {
    ...
    protected void bindChildView(View view, Context context, Cursor cursor, boolean z) throws Throwable {
    ...
    @Override // android.widget.CursorTreeAdapter
    protected void bindGroupView(View view, Context context, Cursor cursor, boolean z) throws Throwable {
    ...
    protected void setViewImage(ImageView imageView, String str) throws Throwable {
        try {
