...
public final class CaptureResult extends CameraMetadata {
    ...
    public static final CameraMetadata.Key<Boolean> QUIRKS_PARTIAL_RESULT = new CameraMetadata.Key<>("android.quirks.partialResult", Boolean.TYPE);
    ...
    public CaptureResult(CameraMetadataNative cameraMetadataNative, CaptureRequest captureRequest, int i) {
        ...
        this.mResults = cameraMetadataNative;
