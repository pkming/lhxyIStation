...
public class MainDispToDev0PlugIn implements DispOutputState {
    ...
    public MainDispToDev0PlugIn(DisplayManagerPolicy2 displayManagerPolicy2) {
    ...
    public void devicePlugChanged(int i, int i2, boolean z) {
        if (!z && i2 == 0) {
            ...
            displayManagerPolicy2.setOutputState(displayManagerPolicy2.getMainDispToDev0PlugOut());
            return;
        }
        if (1 == i2 && true == z) {
