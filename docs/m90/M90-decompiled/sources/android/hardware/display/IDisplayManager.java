...
public interface IDisplayManager extends IInterface {
    ...
    int getDisplayParameter(int i, int i2, int i3, int i4) throws RemoteException;
    ...
    int setDisplayParameter(int i, int i2, int i3, int i4, int i5) throws RemoteException;
    ...
    public static abstract class Stub extends Binder implements IDisplayManager {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            ...
            switch (i) {
                ...
                case 13:
                    parcel.enforceInterface(DESCRIPTOR);
                    int iCreateVirtualDisplay = createVirtualDisplay(parcel.readStrongBinder(), parcel.readString(), parcel.readString(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt() != 0 ? Surface.CREATOR.createFromParcel(parcel) : null, parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeInt(iCreateVirtualDisplay);
                    return true;
                case 14:
                    parcel.enforceInterface(DESCRIPTOR);
                    releaseVirtualDisplay(parcel.readStrongBinder());
                    parcel2.writeNoException();
                    return true;
                case 15:
                    parcel.enforceInterface(DESCRIPTOR);
                    int displayParameter = getDisplayParameter(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeInt(displayParameter);
                    return true;
                case 16:
                    parcel.enforceInterface(DESCRIPTOR);
                    int displayParameter2 = setDisplayParameter(parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt(), parcel.readInt());
                    parcel2.writeNoException();
                    parcel2.writeInt(displayParameter2);
                    return true;
                default:
        ...
        private static class Proxy implements IDisplayManager {
            ...
            public DisplayInfo getDisplayInfo(int i) throws RemoteException {
                ...
                try {
                    ...
                    return parcelObtain2.readInt() != 0 ? DisplayInfo.CREATOR.createFromParcel(parcelObtain2) : null;
                } finally {
            ...
            public WifiDisplayStatus getWifiDisplayStatus() throws RemoteException {
                ...
                try {
                    ...
                    parcelObtain2.readException();
                    return parcelObtain2.readInt() != 0 ? WifiDisplayStatus.CREATOR.createFromParcel(parcelObtain2) : null;
                } finally {
                    parcelObtain2.recycle();
                    parcelObtain.recycle();
                }
            ...
            @Override // android.hardware.display.IDisplayManager
            public int createVirtualDisplay(IBinder iBinder, String str, String str2, int i, int i2, int i3, Surface surface, int i4) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.hardware.display.IDisplayManager
            public void releaseVirtualDisplay(IBinder iBinder) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.hardware.display.IDisplayManager
            public int getDisplayParameter(int i, int i2, int i3, int i4) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
            ...
            @Override // android.hardware.display.IDisplayManager
            public int setDisplayParameter(int i, int i2, int i3, int i4, int i5) throws RemoteException {
                Parcel parcelObtain = Parcel.obtain();
                Parcel parcelObtain2 = Parcel.obtain();
                try {
                    parcelObtain.writeInterfaceToken(Stub.DESCRIPTOR);
