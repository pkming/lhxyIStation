    ...
    public static abstract class Stub extends Binder implements IGeofenceHardwareMonitorCallback {
        ...
        public boolean onTransact(int i, Parcel parcel, Parcel parcel2, int i2) throws RemoteException {
            if (i == 1) {
                ...
                onMonitoringSystemChange(parcel.readInt(), parcel.readInt() != 0, parcel.readInt() != 0 ? Location.CREATOR.createFromParcel(parcel) : null);
                return true;
            }
            if (i == 1598968902) {
        ...
        private static class Proxy implements IGeofenceHardwareMonitorCallback {
            ...
            public void onMonitoringSystemChange(int i, boolean z, Location location) throws RemoteException {
