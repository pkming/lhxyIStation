    ...
    public boolean addGeofence(int i, int i2, GeofenceHardwareRequest geofenceHardwareRequest, GeofenceHardwareCallback geofenceHardwareCallback) {
        try {
            if (geofenceHardwareRequest.getType() == 0) {
                return this.mService.addCircularFence(i, i2, geofenceHardwareRequest.getLatitude(), geofenceHardwareRequest.getLongitude(), geofenceHardwareRequest.getRadius(), geofenceHardwareRequest.getLastTransition(), geofenceHardwareRequest.getMonitorTransitions(), geofenceHardwareRequest.getNotificationResponsiveness(), geofenceHardwareRequest.getUnknownTimer(), getCallbackWrapper(geofenceHardwareCallback));
            }
    ...
    class GeofenceHardwareMonitorCallbackWrapper extends IGeofenceHardwareMonitorCallback.Stub {
        ...
        public void onMonitoringSystemChange(int i, boolean z, Location location) {
            ...
            if (geofenceHardwareMonitorCallback != null) {
                geofenceHardwareMonitorCallback.onMonitoringSystemChange(i, z, location);
            }
        }
    }
