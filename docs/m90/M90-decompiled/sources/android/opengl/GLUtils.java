...
public final class GLUtils {
    ...
    public static int getInternalFormat(Bitmap bitmap) {
        Objects.requireNonNull(bitmap, "getInternalFormat can't be used with a null Bitmap");
    ...
    public static int getType(Bitmap bitmap) {
        Objects.requireNonNull(bitmap, "getType can't be used with a null Bitmap");
        if (bitmap.isRecycled()) {
            throw new IllegalArgumentException("bitmap is recycled");
        }
    ...
    public static void texSubImage2D(int i, int i2, int i3, int i4, Bitmap bitmap) {
        Objects.requireNonNull(bitmap, "texSubImage2D can't be used with a null Bitmap");
        if (bitmap.isRecycled()) {
            throw new IllegalArgumentException("bitmap is recycled");
        }
