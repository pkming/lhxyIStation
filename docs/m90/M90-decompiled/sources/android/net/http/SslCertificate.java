...
public class SslCertificate {
    ...
    public View inflateCertificateView(Context context) {
        View viewInflate = LayoutInflater.from(context).inflate(17367202, (ViewGroup) null);
        DName issuedTo = getIssuedTo();
        if (issuedTo != null) {
            ((TextView) viewInflate.findViewById(16909112)).setText(issuedTo.getCName());
            ((TextView) viewInflate.findViewById(16909114)).setText(issuedTo.getOName());
            ((TextView) viewInflate.findViewById(16909116)).setText(issuedTo.getUName());
        }
        ((TextView) viewInflate.findViewById(16909118)).setText(getSerialNumber(this.mX509Certificate));
        DName issuedBy = getIssuedBy();
        if (issuedBy != null) {
            ((TextView) viewInflate.findViewById(16909120)).setText(issuedBy.getCName());
            ((TextView) viewInflate.findViewById(16909122)).setText(issuedBy.getOName());
            ((TextView) viewInflate.findViewById(16909124)).setText(issuedBy.getUName());
        }
        ((TextView) viewInflate.findViewById(16909127)).setText(formatCertificateDate(context, getValidNotBeforeDate()));
        ((TextView) viewInflate.findViewById(16909129)).setText(formatCertificateDate(context, getValidNotAfterDate()));
        ((TextView) viewInflate.findViewById(16909132)).setText(getDigest(this.mX509Certificate, "SHA256"));
        ((TextView) viewInflate.findViewById(16909134)).setText(getDigest(this.mX509Certificate, "SHA1"));
        return viewInflate;
    }
