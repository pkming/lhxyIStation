...
public interface IAnonymousSyncAdapter extends IInterface {
    ...
    public static abstract class Stub extends Binder implements IAnonymousSyncAdapter {
        ...
        public static IAnonymousSyncAdapter asInterface(IBinder iBinder) {
            if (iBinder == null) {
                return null;
            }
            IInterface iInterfaceQueryLocalInterface = iBinder.queryLocalInterface(DESCRIPTOR);
            if (iInterfaceQueryLocalInterface != null && (iInterfaceQueryLocalInterface instanceof IAnonymousSyncAdapter)) {
                return (IAnonymousSyncAdapter) iInterfaceQueryLocalInterface;
            }
