...
public final class SyncResult implements Parcelable {
    ...
    public String toDebugString() {
        ...
        if (this.stats.numConflictDetectedExceptions > 0) {
            stringBuffer.append(FullBackup.CACHE_TREE_TOKEN).append(this.stats.numConflictDetectedExceptions);
        }
        if (this.stats.numAuthExceptions > 0) {
            stringBuffer.append(FullBackup.APK_TREE_TOKEN).append(this.stats.numAuthExceptions);
        }
        if (this.tooManyDeletions) {
