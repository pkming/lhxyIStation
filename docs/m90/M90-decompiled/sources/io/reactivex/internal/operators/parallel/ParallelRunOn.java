        ...
        if (validate(subscriberArr)) {
            ...
            for (int i2 = 0; i2 < length; i2++) {
                ...
                if (subscriber instanceof ConditionalSubscriber) {
                    subscriberArr2[i2] = new RunOnConditionalSubscriber((ConditionalSubscriber) subscriber, i, spscArrayQueue, workerCreateWorker);
                } else {
                    subscriberArr2[i2] = new RunOnSubscriber(subscriber, i, spscArrayQueue, workerCreateWorker);
                }
            }
    ...
    static final class RunOnSubscriber<T> extends BaseRunOnSubscriber<T> {
        ...
        public void run() {
            ...
            while (true) {
                ...
                if (j2 != 0 && j != LinkQualityInfo.UNKNOWN_LONG) {
